...
module TCDotProduct_1(	// dependencies/fpuv2/src/main/scala/Tensor.scala:87:7
  ...
  TCMulPipe_8 muls_0 (	// dependencies/fpuv2/src/main/scala/Tensor.scala:108:24
    .clock               (clock),
    .reset               (reset),
  ...
  TCAddPipe_8 adds_0_0 (	// dependencies/fpuv2/src/main/scala/Tensor.scala:102:32
    .clock               (clock),
    .reset               (reset),
  ...
  TCAddPipe_8 adds_1_0 (	// dependencies/fpuv2/src/main/scala/Tensor.scala:102:32
    .clock               (clock),
    .reset               (reset),
  ...
  TCAddPipe_8 adds_2_0 (	// dependencies/fpuv2/src/main/scala/Tensor.scala:102:32
    .clock               (clock),
    .reset               (reset),
  ...
  TCAddPipe_8 finalAdd (	// dependencies/fpuv2/src/main/scala/Tensor.scala:161:24
    .clock               (clock),
    .reset               (reset),
