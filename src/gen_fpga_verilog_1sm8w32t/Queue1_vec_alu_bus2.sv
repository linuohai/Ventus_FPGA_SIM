...
module Queue1_vec_alu_bus2(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  input  [31:0] io_enq_bits_if_mask,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input         io_deq_ready,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output        io_deq_valid,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [2:0]  io_deq_bits_wid,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [31:0] io_deq_bits_if_mask	// src/main/scala/chisel3/util/Decoupled.scala:255:14
);

  reg  [34:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      ram <= {io_enq_bits_if_mask, io_enq_bits_wid};	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Decoupled.scala:243:7
        ...
        ram = {_RANDOM[1'h0][31:1], _RANDOM[1'h1][3:0]};	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  ...
  assign io_deq_bits_if_mask = ram[34:3];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
endmodule
