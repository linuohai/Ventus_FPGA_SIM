...
module cu_interface(	// ventus/src/cta/cu_interface.scala:14:7
  ...
  input  [5:0]  io_wgbuffer_wg_new_bits_num_thread_per_wf,	// ventus/src/cta/cu_interface.scala:16:14
  ...
  input  [17:0] io_wgbuffer_wg_new_bits_num_pds_per_wf,	// ventus/src/cta/cu_interface.scala:16:14
  ...
  output [5:0]  io_cu_wf_new_0_bits_num_thread_per_wf,	// ventus/src/cta/cu_interface.scala:16:14
  ...
  wire [10:0] _fifo_io_deq_bits_vgpr_base;	// ventus/src/cta/cu_interface.scala:46:20
  wire [11:0] _fifo_io_deq_bits_num_sgpr_per_wf;	// ventus/src/cta/cu_interface.scala:46:20
  wire [11:0] _fifo_io_deq_bits_num_vgpr_per_wf;	// ventus/src/cta/cu_interface.scala:46:20
  wire [17:0] _fifo_io_deq_bits_num_pds_per_wf;	// ventus/src/cta/cu_interface.scala:46:20
  ...
  reg  [10:0] splitter_vgpr_addr;	// ventus/src/cta/cu_interface.scala:74:31
  ...
  always @(posedge clock) begin	// ventus/src/cta/cu_interface.scala:14:7
    ...
    splitter_vgpr_addr <=
      splitter_load_new
        ...
        : _splitter_pds_addr_T
            ? splitter_vgpr_addr + _fifo_io_deq_bits_num_vgpr_per_wf[10:0]
    ...
    if (splitter_load_new)	// ventus/src/cta/cu_interface.scala:76:50
      ...
      splitter_pds_addr <= splitter_pds_addr + {14'h0, _fifo_io_deq_bits_num_pds_per_wf};	// ventus/src/cta/cu_interface.scala:46:20, :75:30, :93:69
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/cta/cu_interface.scala:14:7
    ...
    initial begin	// ventus/src/cta/cu_interface.scala:14:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/cta/cu_interface.scala:14:7
        ...
        splitter_vgpr_addr = _RANDOM[2'h0][25:15];	// ventus/src/cta/cu_interface.scala:14:7, :71:29, :74:31
        splitter_pds_addr = {_RANDOM[2'h0][31:26], _RANDOM[2'h1][25:0]};	// ventus/src/cta/cu_interface.scala:14:7, :71:29, :75:30
        wf_gather_ram_valid_0_0 = _RANDOM[2'h1][26];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_1 = _RANDOM[2'h1][27];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_2 = _RANDOM[2'h1][28];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_3 = _RANDOM[2'h1][29];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_4 = _RANDOM[2'h1][30];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_5 = _RANDOM[2'h1][31];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_6 = _RANDOM[2'h2][0];	// ventus/src/cta/cu_interface.scala:14:7, :128:51
        wf_gather_ram_valid_0_7 = _RANDOM[2'h2][1];	// ventus/src/cta/cu_interface.scala:14:7, :128:51
        fsm = _RANDOM[2'h2][3:2];	// ventus/src/cta/cu_interface.scala:14:7, :128:51, :147:20
        wf_wgslot_reg = _RANDOM[2'h2][6:4];	// ventus/src/cta/cu_interface.scala:14:7, :128:51, :162:32
        init_wf_gather_cnt_idx = _RANDOM[2'h2][10:7];	// ventus/src/cta/cu_interface.scala:14:7, :128:51, :166:39
        wf_gather_ram_read_data_tmp = _RANDOM[2'h2][11];	// ventus/src/cta/cu_interface.scala:14:7, :128:51, :173:22
        wf_gather_ram_read_data_r_num_wf = _RANDOM[2'h2][15:12];	// ventus/src/cta/cu_interface.scala:14:7, :128:51, :175:29
        wf_gather_ram_read_data_r_wg_id = {_RANDOM[2'h2][31:16], _RANDOM[2'h3][15:0]};	// ventus/src/cta/cu_interface.scala:14:7, :128:51, :175:29
        wf_gather_ram_read_data_r_lds_dealloc_en = _RANDOM[2'h3][16];	// ventus/src/cta/cu_interface.scala:14:7, :175:29
        wf_gather_ram_read_data_r_sgpr_dealloc_en = _RANDOM[2'h3][17];	// ventus/src/cta/cu_interface.scala:14:7, :175:29
        wf_gather_ram_read_data_r_vgpr_dealloc_en = _RANDOM[2'h3][18];	// ventus/src/cta/cu_interface.scala:14:7, :175:29
        rt_dealloc_ok = _RANDOM[2'h3][19];	// ventus/src/cta/cu_interface.scala:14:7, :175:29, :200:42
        host_wg_done_ok = _RANDOM[2'h3][20];	// ventus/src/cta/cu_interface.scala:14:7, :175:29, :217:44
      `endif // RANDOMIZE_REG_INIT
    end // initial
