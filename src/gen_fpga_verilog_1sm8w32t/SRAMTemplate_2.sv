...
module SRAMTemplate_2(	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
  ...
  output [16:0] io_r_resp_data_0,	// ventus/src/SRAMTemplate/SRAMTemplate.scala:90:14
  ...
  input  [16:0] io_w_req_bits_data_0,	// ventus/src/SRAMTemplate/SRAMTemplate.scala:90:14
  ...
  wire [33:0] _array_R0_data;	// ventus/src/SRAMTemplate/SRAMTemplate.scala:96:26
  reg  [16:0] bypass_wdata_REG_0;	// ventus/src/SRAMTemplate/SRAMTemplate.scala:128:54
  reg  [16:0] bypass_wdata_REG_1;	// ventus/src/SRAMTemplate/SRAMTemplate.scala:128:54
  ...
  wire [16:0] mem_rdata_0 = bypass_mask[0] ? bypass_wdata_REG_0 : _array_R0_data[16:0];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:96:26, :125:67, :128:54, :133:30, :134:30
  wire [16:0] mem_rdata_1 = bypass_mask[1] ? bypass_wdata_REG_1 : _array_R0_data[33:17];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:96:26, :125:67, :128:54, :133:30, :134:30
  reg         rdata_REG;	// ventus/src/SRAMTemplate/SRAMTemplate.scala:139:59
  reg  [16:0] rdata_r_0;	// ventus/src/SRAMTemplate/Hold.scala:18:65
  reg  [16:0] rdata_r_1;	// ventus/src/SRAMTemplate/Hold.scala:18:65
  always @(posedge clock) begin	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
    ...
    if (reset) begin	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
      rdata_r_0 <= 17'h0;	// ventus/src/SRAMTemplate/Hold.scala:18:65, ventus/src/SRAMTemplate/SRAMTemplate.scala:112:51
      rdata_r_1 <= 17'h0;	// ventus/src/SRAMTemplate/Hold.scala:18:65, ventus/src/SRAMTemplate/SRAMTemplate.scala:112:51
    end
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
    ...
    initial begin	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
      automatic logic [31:0] _RANDOM[0:2];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
        ...
        bypass_wdata_REG_0 = _RANDOM[2'h0][16:0];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :128:54
        bypass_wdata_REG_1 = {_RANDOM[2'h0][31:17], _RANDOM[2'h1][1:0]};	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :128:54
        bypass_mask_need_check = _RANDOM[2'h1][2];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :121:29, :128:54
        bypass_mask_waddr_reg = _RANDOM[2'h1][10:3];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :122:28, :128:54
        bypass_mask_raddr_reg = _RANDOM[2'h1][18:11];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :123:28, :128:54
        bypass_mask_bypass_REG = _RANDOM[2'h1][20:19];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :125:76, :128:54
        rdata_REG = _RANDOM[2'h1][21];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :128:54, :139:59
        rdata_r_0 = {_RANDOM[2'h1][31:22], _RANDOM[2'h2][6:0]};	// ventus/src/SRAMTemplate/Hold.scala:18:65, ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :128:54
        rdata_r_1 = _RANDOM[2'h2][23:7];	// ventus/src/SRAMTemplate/Hold.scala:18:65, ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  array_1 array (	// ventus/src/SRAMTemplate/SRAMTemplate.scala:96:26
