...
module data_4x512(	// ventus/src/pipeline/MSHR.scala:31:17
  input  [1:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [511:0] Memory[0:3];	// ventus/src/pipeline/MSHR.scala:31:17
  ...
  `ifdef ENABLE_INITIAL_MEM_	// ventus/src/pipeline/MSHR.scala:31:17
    reg [511:0] _RANDOM_MEM;	// ventus/src/pipeline/MSHR.scala:31:17
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 512'bx;	// ventus/src/pipeline/MSHR.scala:31:17
endmodule
