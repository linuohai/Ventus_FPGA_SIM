...
module ram_32x1059(	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  input  [4:0]    R0_addr,
  input           R0_en,
                  R0_clk,
  ...
  reg [1058:0] Memory[0:31];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  `ifdef ENABLE_INITIAL_MEM_	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    reg [1087:0] _RANDOM_MEM;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:256:91
        for (logic [5:0] i = 6'h0; i < 6'h20; i += 6'h1) begin
          for (logic [10:0] j = 11'h0; j < 11'h440; j += 11'h20) begin
          ...
          Memory[i[4:0]] = _RANDOM_MEM[1058:0];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
        end	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 1059'bx;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
endmodule
