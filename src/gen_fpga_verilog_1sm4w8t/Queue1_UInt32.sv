...
module Queue1_UInt32(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    else if (~(do_enq == (full & io_deq_ready & (io_enq_valid | full))))	// src/main/scala/chisel3/util/Decoupled.scala:259:27, :263:27, :264:27, :276:{15,27}, :277:16, :285:16, :297:{24,39}, :298:17, :300:14, :301:{26,35}
