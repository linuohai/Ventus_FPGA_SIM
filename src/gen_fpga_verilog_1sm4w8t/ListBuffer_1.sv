...
module ListBuffer_1(	// ventus/src/L2cache/ListBuffer.scala:33:7
  ...
  input  [2:0]    io_push_bits_data_opcode,	// ventus/src/L2cache/ListBuffer.scala:35:14
  input  [4:0]    io_push_bits_data_put,	// ventus/src/L2cache/ListBuffer.scala:35:14
  input  [14:0]   io_push_bits_data_source,	// ventus/src/L2cache/ListBuffer.scala:35:14
  ...
  output [2:0]    io_data_opcode,	// ventus/src/L2cache/ListBuffer.scala:35:14
  output [4:0]    io_data_put,	// ventus/src/L2cache/ListBuffer.scala:35:14
  output [14:0]   io_data_source	// ventus/src/L2cache/ListBuffer.scala:35:14
);

  wire [1174:0] _data_ext_R0_data;	// ventus/src/L2cache/ListBuffer.scala:50:18
  ...
  data_32x1175 data_ext (	// ventus/src/L2cache/ListBuffer.scala:50:18
    .R0_addr (_head_ext_R0_data),	// ventus/src/L2cache/ListBuffer.scala:46:18
    .R0_en   (1'h1),	// ventus/src/L2cache/ListBuffer.scala:33:7
    .R0_clk  (clock),
    ...
    .W0_data
      ({io_push_bits_data_mask,
        ...
        io_push_bits_data_source})	// ventus/src/L2cache/ListBuffer.scala:71:43
  );
  ...
  assign io_data_mask = _data_ext_R0_data[1174:1047];	// ventus/src/L2cache/ListBuffer.scala:33:7, :50:18, :91:63
  assign io_data_data = _data_ext_R0_data[1046:23];	// ventus/src/L2cache/ListBuffer.scala:33:7, :50:18, :91:63
  assign io_data_opcode = _data_ext_R0_data[22:20];	// ventus/src/L2cache/ListBuffer.scala:33:7, :50:18, :91:63
  assign io_data_put = _data_ext_R0_data[19:15];	// ventus/src/L2cache/ListBuffer.scala:33:7, :50:18, :91:63
  assign io_data_source = _data_ext_R0_data[14:0];	// ventus/src/L2cache/ListBuffer.scala:33:7, :50:18, :91:63
endmodule
