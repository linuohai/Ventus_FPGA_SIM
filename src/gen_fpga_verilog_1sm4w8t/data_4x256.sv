...
module data_4x256(	// ventus/src/pipeline/MSHR.scala:31:17
  input  [1:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [255:0] Memory[0:3];	// ventus/src/pipeline/MSHR.scala:31:17
  ...
  `ifdef ENABLE_INITIAL_MEM_	// ventus/src/pipeline/MSHR.scala:31:17
    reg [255:0] _RANDOM_MEM;	// ventus/src/pipeline/MSHR.scala:31:17
    initial begin	// ventus/src/pipeline/MSHR.scala:31:17
      ...
      `ifdef RANDOMIZE_MEM_INIT	// ventus/src/pipeline/MSHR.scala:31:17
        for (logic [2:0] i = 3'h0; i < 3'h4; i += 3'h1) begin
          ...
          Memory[i[1:0]] = _RANDOM_MEM;	// ventus/src/pipeline/MSHR.scala:31:17
        end	// ventus/src/pipeline/MSHR.scala:31:17
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 256'bx;	// ventus/src/pipeline/MSHR.scala:31:17
endmodule
