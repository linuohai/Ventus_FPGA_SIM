...
module CSRFile(	// ventus/src/pipeline/CSR.scala:87:7
  ...
  input  [3:0]  io_CTA2csr_bits_CTAdata_dispatch2cu_wg_wf_count,	// ventus/src/pipeline/CSR.scala:88:12
  input  [5:0]  io_CTA2csr_bits_CTAdata_dispatch2cu_wf_size_dispatch,	// ventus/src/pipeline/CSR.scala:88:12
  input  [11:0] io_CTA2csr_bits_CTAdata_dispatch2cu_sgpr_base_dispatch,	// ventus/src/pipeline/CSR.scala:88:12
  ...
  input  [5:0]  io_CTA2csr_bits_CTAdata_dispatch2cu_wf_tag_dispatch,	// ventus/src/pipeline/CSR.scala:88:12
  ...
  output [11:0] io_sgpr_base,	// ventus/src/pipeline/CSR.scala:88:12
  ...
  reg  [3:0]  wg_wf_count;	// ventus/src/pipeline/CSR.scala:161:24
  ...
  reg  [5:0]  wf_tag_dispatch;	// ventus/src/pipeline/CSR.scala:165:28
  ...
  reg  [11:0] sgpr_base_dispatch;	// ventus/src/pipeline/CSR.scala:174:31
  reg  [11:0] vgpr_base_dispatch;	// ventus/src/pipeline/CSR.scala:175:31
  ...
  wire [31:0] io_lsu_numw_0 = {28'h0, wg_wf_count};	// src/main/scala/chisel3/util/Lookup.scala:34:39, ventus/src/pipeline/CSR.scala:161:24
  wire [31:0] csr_rdata =
  ...
  always @(posedge clock) begin	// ventus/src/pipeline/CSR.scala:87:7
    if (reset) begin	// ventus/src/pipeline/CSR.scala:87:7
      ...
      if (io_CTA2csr_valid) begin	// ventus/src/pipeline/CSR.scala:88:12
        threadid <=
          {24'h0, io_CTA2csr_bits_CTAdata_dispatch2cu_wf_tag_dispatch[2:0], 5'h0};	// ventus/src/pipeline/CSR.scala:160:25, :188:17, :302:74, :312:{13,82}
        lds_base_dispatch <=
    ...
    if (io_CTA2csr_valid) begin	// ventus/src/pipeline/CSR.scala:88:12
      ...
      wf_size_dispatch <= {4'h0, io_CTA2csr_bits_CTAdata_dispatch2cu_wf_size_dispatch};	// ventus/src/pipeline/CSR.scala:87:7, :162:29, :299:22
      ...
      wf_tag_dispatch <= {3'h0, io_CTA2csr_bits_CTAdata_dispatch2cu_wf_tag_dispatch[2:0]};	// ventus/src/pipeline/CSR.scala:165:28, :187:20, :302:{21,74}
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/pipeline/CSR.scala:87:7
    ...
    initial begin	// ventus/src/pipeline/CSR.scala:87:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/pipeline/CSR.scala:87:7
        ...
        wg_wf_count = _RANDOM[4'h5][11:8];	// ventus/src/pipeline/CSR.scala:87:7, :160:25, :161:24
        wf_size_dispatch = _RANDOM[4'h5][21:12];	// ventus/src/pipeline/CSR.scala:87:7, :160:25, :162:29
        knl_base = {_RANDOM[4'h5][31:22], _RANDOM[4'h6][21:0]};	// ventus/src/pipeline/CSR.scala:87:7, :160:25, :163:21
        wg_id = {_RANDOM[4'h6][31:22], _RANDOM[4'h7][21:0]};	// ventus/src/pipeline/CSR.scala:87:7, :163:21, :164:18
        wf_tag_dispatch = _RANDOM[4'h7][27:22];	// ventus/src/pipeline/CSR.scala:87:7, :164:18, :165:28
        lds_base_dispatch = {_RANDOM[4'h7][31:28], _RANDOM[4'h8][27:0]};	// ventus/src/pipeline/CSR.scala:87:7, :164:18, :166:34
        pds_baseaddr = {_RANDOM[4'h8][31:28], _RANDOM[4'h9][27:0]};	// ventus/src/pipeline/CSR.scala:87:7, :166:34, :167:29
        wg_id_x = {_RANDOM[4'h9][31:28], _RANDOM[4'hA][6:0]};	// ventus/src/pipeline/CSR.scala:87:7, :167:29, :168:24
        wg_id_y = _RANDOM[4'hA][17:7];	// ventus/src/pipeline/CSR.scala:87:7, :168:24, :169:24
        wg_id_z = _RANDOM[4'hA][28:18];	// ventus/src/pipeline/CSR.scala:87:7, :168:24, :170:24
        csr_print = {_RANDOM[4'hA][31:29], _RANDOM[4'hB][28:0]};	// ventus/src/pipeline/CSR.scala:87:7, :168:24, :171:26
        rpc = {_RANDOM[4'hB][31:29], _RANDOM[4'hC][28:0]};	// ventus/src/pipeline/CSR.scala:87:7, :171:26, :172:18
        sgpr_base_dispatch = {_RANDOM[4'hC][31:29], _RANDOM[4'hD][8:0]};	// ventus/src/pipeline/CSR.scala:87:7, :172:18, :174:31
        vgpr_base_dispatch = _RANDOM[4'hD][20:9];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :175:31
        NV = _RANDOM[4'hD][21];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :181:19
        DZ = _RANDOM[4'hD][22];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :182:19
        OF = _RANDOM[4'hD][23];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :183:19
        UF = _RANDOM[4'hD][24];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :184:19
        NX = _RANDOM[4'hD][25];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :185:19
        frm = _RANDOM[4'hD][28:26];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :187:20
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_wb_wxd_rd =
    wen
      ? (io_ctrl_custom_signal_0
           ? io_in1
           : io_ctrl_isvec ? (io_in1 < 32'h20 ? io_in1 : 32'h20) : csr_rdata)
  ...
  assign io_lsu_tid = {21'h0, wf_tag_dispatch, 5'h0};	// src/main/scala/chisel3/util/Lookup.scala:34:39, ventus/src/pipeline/CSR.scala:87:7, :165:28, :312:82, :315:14
