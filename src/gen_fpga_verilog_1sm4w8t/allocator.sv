...
module allocator(	// ventus/src/cta/allocator.scala:102:7
  ...
  input  [11:0] io_wgbuffer_wg_new_bits_num_sgpr,	// ventus/src/cta/allocator.scala:108:14
  ...
  output [11:0] io_rt_alloc_bits_num_sgpr,	// ventus/src/cta/allocator.scala:108:14
  ...
  input  [11:0] io_rt_result_sgpr_bits_size_0,	// ventus/src/cta/allocator.scala:108:14
  ...
  input  [11:0] io_rt_result_vgpr_bits_size_0,	// ventus/src/cta/allocator.scala:108:14
  ...
  wire [11:0] _writer_vgpr_io_rtcache_wr_data_size_0;	// ventus/src/cta/allocator.scala:149:27
  wire [11:0] _writer_vgpr_io_rtcache_wr_data_size_1;	// ventus/src/cta/allocator.scala:149:27
  ...
  wire [11:0] _writer_sgpr_io_rtcache_wr_data_size_0;	// ventus/src/cta/allocator.scala:148:27
  wire [11:0] _writer_sgpr_io_rtcache_wr_data_size_1;	// ventus/src/cta/allocator.scala:148:27
  ...
  reg  [11:0] rtcache_sgpr_0_size_0;	// ventus/src/cta/allocator.scala:136:29
  reg  [11:0] rtcache_sgpr_0_size_1;	// ventus/src/cta/allocator.scala:136:29
  reg  [11:0] rtcache_vgpr_0_size_0;	// ventus/src/cta/allocator.scala:141:29
  reg  [11:0] rtcache_vgpr_0_size_1;	// ventus/src/cta/allocator.scala:141:29
  ...
  reg  [11:0] wg_num_sgpr;	// ventus/src/cta/allocator.scala:187:21
  reg  [11:0] wg_num_vgpr;	// ventus/src/cta/allocator.scala:187:21
  ...
  always @(posedge clock) begin	// ventus/src/cta/allocator.scala:102:7
    ...
    if (reset) begin	// ventus/src/cta/allocator.scala:102:7
      ...
      rtcache_sgpr_0_size_0 <= 12'h800;	// ventus/src/cta/allocator.scala:136:29, :137:25
      rtcache_sgpr_0_size_1 <= 12'h0;	// ventus/src/cta/allocator.scala:136:29, :137:25
      rtcache_vgpr_0_size_0 <= 12'h800;	// ventus/src/cta/allocator.scala:137:25, :141:29
      rtcache_vgpr_0_size_1 <= 12'h0;	// ventus/src/cta/allocator.scala:137:25, :141:29
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/cta/allocator.scala:102:7
    ...
    initial begin	// ventus/src/cta/allocator.scala:102:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/cta/allocator.scala:102:7
        ...
        rtcache_sgpr_0_size_0 = _RANDOM[3'h1][15:4];	// ventus/src/cta/allocator.scala:102:7, :131:28, :136:29
        rtcache_sgpr_0_size_1 = _RANDOM[3'h1][27:16];	// ventus/src/cta/allocator.scala:102:7, :131:28, :136:29
        rtcache_vgpr_0_size_0 = {_RANDOM[3'h1][31:28], _RANDOM[3'h2][7:0]};	// ventus/src/cta/allocator.scala:102:7, :131:28, :141:29
        rtcache_vgpr_0_size_1 = _RANDOM[3'h2][19:8];	// ventus/src/cta/allocator.scala:102:7, :141:29
        wgslot_0 = _RANDOM[3'h2][27:20];	// ventus/src/cta/allocator.scala:102:7, :141:29, :162:23
        wfslot_0 = _RANDOM[3'h2][31:28];	// ventus/src/cta/allocator.scala:102:7, :141:29, :163:23
        wgslot_id = _RANDOM[3'h3][2:0];	// ventus/src/cta/allocator.scala:102:7, :165:22
        wgslot_id_1H = _RANDOM[3'h3][10:3];	// ventus/src/cta/allocator.scala:102:7, :165:22, :166:25
        fsm = _RANDOM[3'h3][13:11];	// ventus/src/cta/allocator.scala:102:7, :165:22, :176:20
        fsm_r1 = _RANDOM[3'h3][16:14];	// ventus/src/cta/allocator.scala:102:7, :165:22, :177:23
        wg_num_wf = _RANDOM[3'h3][20:17];	// ventus/src/cta/allocator.scala:102:7, :165:22, :187:21
        wg_num_sgpr = {_RANDOM[3'h3][31:21], _RANDOM[3'h4][0]};	// ventus/src/cta/allocator.scala:102:7, :165:22, :187:21
        wg_num_vgpr = _RANDOM[3'h4][12:1];	// ventus/src/cta/allocator.scala:102:7, :187:21
        wg_num_lds = _RANDOM[3'h4][30:13];	// ventus/src/cta/allocator.scala:102:7, :187:21
        wg_wg_id = {_RANDOM[3'h4][31], _RANDOM[3'h5][30:0]};	// ventus/src/cta/allocator.scala:102:7, :187:21
        wg_wgram_addr = {_RANDOM[3'h5][31], _RANDOM[3'h6][1:0]};	// ventus/src/cta/allocator.scala:102:7, :187:21
        cu_cnt = _RANDOM[3'h6][2];	// ventus/src/cta/allocator.scala:102:7, :187:21, :191:23
        rtcache_lds_sel = _RANDOM[3'h6][3];	// ventus/src/cta/allocator.scala:102:7, :187:21, :278:35
        rtcache_sgpr_sel = _RANDOM[3'h6][4];	// ventus/src/cta/allocator.scala:102:7, :187:21, :279:35
        rtcache_vgpr_sel = _RANDOM[3'h6][5];	// ventus/src/cta/allocator.scala:102:7, :187:21, :280:35
        alloc_task_rt_reg = _RANDOM[3'h6][6];	// ventus/src/cta/allocator.scala:102:7, :187:21, :316:34
        alloc_task_cuinterface_reg = _RANDOM[3'h6][7];	// ventus/src/cta/allocator.scala:102:7, :187:21, :328:43
        alloc_task_wgram2_reg = _RANDOM[3'h6][8];	// ventus/src/cta/allocator.scala:102:7, :187:21, :344:38
      `endif // RANDOMIZE_REG_INIT
    end // initial
