...
module pipe_1(	// ventus/src/pipeline/pipe.scala:32:7
  ...
  wire [7:0]  _control_io_control_0_spike_info_sm_id;	// ventus/src/pipeline/pipe.scala:56:21
  ...
  wire [7:0]  _control_io_control_1_spike_info_sm_id;	// ventus/src/pipeline/pipe.scala:56:21
  ...
  `ifndef SYNTHESIS	// ventus/src/pipeline/pipe.scala:128:13
    always @(posedge clock) begin	// ventus/src/pipeline/pipe.scala:128:13
      if ((`PRINTF_COND_) & _issueX_io_out_CSR_valid
        ...
        $fwrite(32'h80000002, "sm 1 warp %d 0x%x 0x%x  setrpc 0x%x \n",
      ...
      if (_scoreb_3_if_fire_T_1 & ~reset & (&_ibuffer2issue_io_out_x_bits_alu_fn)) begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35, ventus/src/pipeline/pipe.scala:90:27, :128:13, :263:{11,24}
        if (`ASSERT_VERBOSE_COND_)	// ventus/src/pipeline/pipe.scala:263:11
          $error("Assertion failed: UNDEFINED INSTRUCTION @ SM 1 warp %d PC 0x%x: 0x%x\n    at pipe.scala:263 assert(ctrl.alu_fn =/= 63.U,\n",
  ...
  InstrDecodeV2 control (	// ventus/src/pipeline/pipe.scala:56:21
    ...
    .io_sm_id                      (8'h1),	// ventus/src/pipeline/pipe.scala:162:20
    ...
    .io_control_0_spike_info_sm_id (_control_io_control_0_spike_info_sm_id),
    ...
    .io_control_1_spike_info_sm_id (_control_io_control_1_spike_info_sm_id),
  ...
  Issue issueX (	// ventus/src/pipeline/pipe.scala:60:22
    ...
    .io_out_vALU_ready                            (1'h0),	// ventus/src/pipeline/pipe.scala:98:28
    ...
    .io_out_vFPU_ready                            (1'h0),	// ventus/src/pipeline/pipe.scala:98:28
    ...
    .io_out_LSU_ready                             (1'h0),	// ventus/src/pipeline/pipe.scala:98:28
    ...
    .io_out_SFU_ready                             (1'h0),	// ventus/src/pipeline/pipe.scala:98:28
    ...
    .io_out_SIMT_ready                            (1'h0),	// ventus/src/pipeline/pipe.scala:98:28
    ...
    .io_out_MUL_ready                             (1'h0),	// ventus/src/pipeline/pipe.scala:98:28
    ...
    .io_out_TC_ready                              (1'h0),	// ventus/src/pipeline/pipe.scala:98:28
  ...
  Issue issueV (	// ventus/src/pipeline/pipe.scala:61:22
    ...
    .io_out_sALU_ready                            (1'h0),	// ventus/src/pipeline/pipe.scala:98:28
    ...
    .io_out_warpscheduler_ready                   (1'h0),	// ventus/src/pipeline/pipe.scala:98:28
    ...
    .io_out_CSR_ready                             (1'h0),	// ventus/src/pipeline/pipe.scala:98:28
  ...
  InstrBufferV2 ibuffer (	// ventus/src/pipeline/pipe.scala:89:21
    ...
    .io_in_bits_control_0_spike_info_sm_id (_control_io_control_0_spike_info_sm_id),	// ventus/src/pipeline/pipe.scala:56:21
    ...
    .io_in_bits_control_1_spike_info_sm_id (_control_io_control_1_spike_info_sm_id),	// ventus/src/pipeline/pipe.scala:56:21
