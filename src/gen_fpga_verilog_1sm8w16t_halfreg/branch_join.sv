...
module branch_join(	// ventus/src/pipeline/branch_join.scala:65:7
  ...
  wire [15:0]      _branch_join_stack_7_io_newMask;	// ventus/src/pipeline/branch_join.scala:112:51
  ...
  wire [15:0]      _branch_join_stack_6_io_newMask;	// ventus/src/pipeline/branch_join.scala:112:51
  ...
  wire [15:0]      _branch_join_stack_5_io_newMask;	// ventus/src/pipeline/branch_join.scala:112:51
  ...
  wire [15:0]      _branch_join_stack_4_io_newMask;	// ventus/src/pipeline/branch_join.scala:112:51
  ...
  reg  [15:0]      thread_masks_4;	// ventus/src/pipeline/branch_join.scala:90:29
  reg  [15:0]      thread_masks_5;	// ventus/src/pipeline/branch_join.scala:90:29
  reg  [15:0]      thread_masks_6;	// ventus/src/pipeline/branch_join.scala:90:29
  reg  [15:0]      thread_masks_7;	// ventus/src/pipeline/branch_join.scala:90:29
  ...
  assign takeif =
    ...
    | ifOnly;	// ventus/src/pipeline/branch_join.scala:102:30, :141:39, :142:51, :143:20, :144:22, :145:{21,32,45}, :146:25, :148:{15,24}
  ...
  wire             _pop_2_T_3 = _branch_ctl_buf_q_io_deq_bits_wid == 3'h2;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:159:73, :235:31
  wire             _pop_3_T_3 = _branch_ctl_buf_q_io_deq_bits_wid == 3'h3;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:159:73, :235:31
  ...
  wire             _pop_5_T_3 = _branch_ctl_buf_q_io_deq_bits_wid == 3'h5;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:159:73
  wire             _pop_6_T_3 = _branch_ctl_buf_q_io_deq_bits_wid == 3'h6;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:159:73
  wire [7:0]       _GEN_0 =
  ...
  always @(posedge clock) begin	// ventus/src/pipeline/branch_join.scala:65:7
    if (reset) begin	// ventus/src/pipeline/branch_join.scala:65:7
      ...
      thread_masks_4 <= 16'hFFFF;	// ventus/src/pipeline/branch_join.scala:90:{29,57}
      thread_masks_5 <= 16'hFFFF;	// ventus/src/pipeline/branch_join.scala:90:{29,57}
      thread_masks_6 <= 16'hFFFF;	// ventus/src/pipeline/branch_join.scala:90:{29,57}
      thread_masks_7 <= 16'hFFFF;	// ventus/src/pipeline/branch_join.scala:90:{29,57}
    end
      ...
      _GEN_8 = _branch_ctl_buf_q_io_deq_bits_wid == 3'h2;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:235:31
      _GEN_9 = _branch_ctl_buf_q_io_deq_bits_wid == 3'h3;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:235:31
      ...
      _GEN_11 = _branch_ctl_buf_q_io_deq_bits_wid == 3'h5;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:159:73, :235:31
      _GEN_12 = _branch_ctl_buf_q_io_deq_bits_wid == 3'h6;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:159:73, :235:31
      if (_q_io_deq_ready_T_1) begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35
        automatic logic [15:0] _GEN_13;	// ventus/src/pipeline/branch_join.scala:90:29, :235:31, :237:31
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/pipeline/branch_join.scala:65:7
    ...
    initial begin	// ventus/src/pipeline/branch_join.scala:65:7
      automatic logic [31:0] _RANDOM[0:3];	// ventus/src/pipeline/branch_join.scala:65:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/pipeline/branch_join.scala:65:7
        for (logic [2:0] i = 3'h0; i < 3'h4; i += 3'h1) begin
          _RANDOM[i[1:0]] = `RANDOM;	// ventus/src/pipeline/branch_join.scala:65:7
        end	// ventus/src/pipeline/branch_join.scala:65:7
        thread_masks_0 = _RANDOM[2'h0][15:0];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
        thread_masks_1 = _RANDOM[2'h0][31:16];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
        thread_masks_2 = _RANDOM[2'h1][15:0];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
        thread_masks_3 = _RANDOM[2'h1][31:16];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
        thread_masks_4 = _RANDOM[2'h2][15:0];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
        thread_masks_5 = _RANDOM[2'h2][31:16];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
        thread_masks_6 = _RANDOM[2'h3][15:0];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
        thread_masks_7 = _RANDOM[2'h3][31:16];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
      `endif // RANDOMIZE_REG_INIT
    end // initial
