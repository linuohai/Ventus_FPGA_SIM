...
module wg_buffer(	// ventus/src/cta/wg_buffer.scala:35:7
  ...
  wire [75:0]  _wgram1_ext_R0_data;	// ventus/src/cta/wg_buffer.scala:55:19
  ...
  always @(posedge clock) begin	// ventus/src/cta/wg_buffer.scala:35:7
    ...
    if (wgram1_rd_act) begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      ...
      wgram1_rd_data_r_num_sgpr <= _wgram1_ext_R0_data[14:4];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
      wgram1_rd_data_r_num_vgpr <= _wgram1_ext_R0_data[25:15];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
      wgram1_rd_data_r_num_lds <= _wgram1_ext_R0_data[43:26];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
      wgram1_rd_data_r_wg_id <= _wgram1_ext_R0_data[75:44];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/cta/wg_buffer.scala:35:7
    ...
    initial begin	// ventus/src/cta/wg_buffer.scala:35:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/cta/wg_buffer.scala:35:7
        ...
        wgram1_rd_data_r_num_sgpr = _RANDOM[4'h0][31:21];	// ventus/src/cta/wg_buffer.scala:35:7, :57:28, :111:30
        wgram1_rd_data_r_num_vgpr = _RANDOM[4'h1][10:0];	// ventus/src/cta/wg_buffer.scala:35:7, :111:30
        wgram1_rd_data_r_num_lds = _RANDOM[4'h1][28:11];	// ventus/src/cta/wg_buffer.scala:35:7, :111:30
        wgram1_rd_data_r_wg_id = {_RANDOM[4'h1][31:29], _RANDOM[4'h2][28:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :111:30
        wgram1_rd_data_addr = _RANDOM[4'h2][31:29];	// ventus/src/cta/wg_buffer.scala:35:7, :111:30, :112:38
        cuinterface_new_wg_valid_r = _RANDOM[4'h3][0];	// ventus/src/cta/wg_buffer.scala:35:7, :128:43
        wgram2_rd_data_num_thread_per_wf = _RANDOM[4'h3][5:1];	// ventus/src/cta/wg_buffer.scala:35:7, :128:43, :133:33
        wgram2_rd_data_gds_base = {_RANDOM[4'h3][31:6], _RANDOM[4'h4][5:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :128:43, :133:33
        wgram2_rd_data_pds_base = {_RANDOM[4'h4][31:6], _RANDOM[4'h5][5:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_start_pc = {_RANDOM[4'h5][31:6], _RANDOM[4'h6][5:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_csr_kernel = {_RANDOM[4'h6][31:6], _RANDOM[4'h7][5:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_x = _RANDOM[4'h7][16:6];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_y = _RANDOM[4'h7][27:17];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_z = {_RANDOM[4'h7][31:28], _RANDOM[4'h8][6:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_sgpr_per_wf = _RANDOM[4'h8][17:7];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_vgpr_per_wf = _RANDOM[4'h8][28:18];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_pds_per_wf = {_RANDOM[4'h8][31:29], _RANDOM[4'h9][13:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_useless = _RANDOM[4'h9][14];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_wg_id = {_RANDOM[4'h9][31:15], _RANDOM[4'hA][14:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        alloc_result_wgid = {_RANDOM[4'hA][31:15], _RANDOM[4'hB][14:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33, :140:38
        wgram_rd2_clear_act_r1 = _RANDOM[4'hB][15];	// ventus/src/cta/wg_buffer.scala:35:7, :140:38, :141:41
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  wgram1_8x76 wgram1_ext (	// ventus/src/cta/wg_buffer.scala:55:19
