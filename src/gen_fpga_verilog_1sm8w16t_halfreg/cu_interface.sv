  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/cta/cu_interface.scala:14:7
    ...
    initial begin	// ventus/src/cta/cu_interface.scala:14:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/cta/cu_interface.scala:14:7
        ...
        splitter_sgpr_addr = _RANDOM[2'h0][13:4];	// ventus/src/cta/cu_interface.scala:14:7, :71:29, :73:31
        splitter_vgpr_addr = _RANDOM[2'h0][23:14];	// ventus/src/cta/cu_interface.scala:14:7, :71:29, :74:31
        splitter_pds_addr = {_RANDOM[2'h0][31:24], _RANDOM[2'h1][23:0]};	// ventus/src/cta/cu_interface.scala:14:7, :71:29, :75:30
        wf_gather_ram_valid_0_0 = _RANDOM[2'h1][24];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_1 = _RANDOM[2'h1][25];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_2 = _RANDOM[2'h1][26];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_3 = _RANDOM[2'h1][27];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_4 = _RANDOM[2'h1][28];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_5 = _RANDOM[2'h1][29];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_6 = _RANDOM[2'h1][30];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        wf_gather_ram_valid_0_7 = _RANDOM[2'h1][31];	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :128:51
        fsm = _RANDOM[2'h2][1:0];	// ventus/src/cta/cu_interface.scala:14:7, :147:20
        wf_wgslot_reg = _RANDOM[2'h2][4:2];	// ventus/src/cta/cu_interface.scala:14:7, :147:20, :162:32
        init_wf_gather_cnt_idx = _RANDOM[2'h2][8:5];	// ventus/src/cta/cu_interface.scala:14:7, :147:20, :166:39
        wf_gather_ram_read_data_tmp = _RANDOM[2'h2][9];	// ventus/src/cta/cu_interface.scala:14:7, :147:20, :173:22
        wf_gather_ram_read_data_r_num_wf = _RANDOM[2'h2][13:10];	// ventus/src/cta/cu_interface.scala:14:7, :147:20, :175:29
        wf_gather_ram_read_data_r_wg_id = {_RANDOM[2'h2][31:14], _RANDOM[2'h3][13:0]};	// ventus/src/cta/cu_interface.scala:14:7, :147:20, :175:29
        wf_gather_ram_read_data_r_lds_dealloc_en = _RANDOM[2'h3][14];	// ventus/src/cta/cu_interface.scala:14:7, :175:29
        wf_gather_ram_read_data_r_sgpr_dealloc_en = _RANDOM[2'h3][15];	// ventus/src/cta/cu_interface.scala:14:7, :175:29
        wf_gather_ram_read_data_r_vgpr_dealloc_en = _RANDOM[2'h3][16];	// ventus/src/cta/cu_interface.scala:14:7, :175:29
        rt_dealloc_ok = _RANDOM[2'h3][17];	// ventus/src/cta/cu_interface.scala:14:7, :175:29, :200:42
        host_wg_done_ok = _RANDOM[2'h3][18];	// ventus/src/cta/cu_interface.scala:14:7, :175:29, :217:44
      `endif // RANDOMIZE_REG_INIT
    end // initial
