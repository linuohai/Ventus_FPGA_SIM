...
module Queue1_FPUOutput(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Decoupled.scala:243:7
        ...
        ram =
          {_RANDOM[3'h0][31:1],
           ...
           _RANDOM[3'h2],
           _RANDOM[3'h3],
           _RANDOM[3'h4][7:0]};	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  ...
  assign io_deq_bits_ctrl_vecMask = ram[60:45];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_wvd = ram[61];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_wxd = ram[62];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_spike_info_sm_id = ram[70:63];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_spike_info_pc = ram[102:71];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_spike_info_inst = ram[134:103];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
endmodule
