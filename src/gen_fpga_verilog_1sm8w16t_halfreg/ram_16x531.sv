...
module ram_16x531(	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  input  [3:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  output [530:0] R0_data,
  input  [3:0]   W0_addr,
  input          W0_en,
                 W0_clk,
  input  [530:0] W0_data
  ...
  reg [530:0] Memory[0:15];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:256:91
        for (logic [4:0] i = 5'h0; i < 5'h10; i += 5'h1) begin
          ...
          Memory[i[3:0]] = _RANDOM_MEM[530:0];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
        end	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 531'bx;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
endmodule
