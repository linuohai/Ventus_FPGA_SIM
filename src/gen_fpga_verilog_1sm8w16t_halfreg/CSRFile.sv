  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/pipeline/CSR.scala:87:7
    ...
    initial begin	// ventus/src/pipeline/CSR.scala:87:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/pipeline/CSR.scala:87:7
        ...
        sgpr_base_dispatch = {_RANDOM[4'hC][31:29], _RANDOM[4'hD][7:0]};	// ventus/src/pipeline/CSR.scala:87:7, :172:18, :174:31
        vgpr_base_dispatch = _RANDOM[4'hD][18:8];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :175:31
        NV = _RANDOM[4'hD][19];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :181:19
        DZ = _RANDOM[4'hD][20];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :182:19
        OF = _RANDOM[4'hD][21];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :183:19
        UF = _RANDOM[4'hD][22];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :184:19
        NX = _RANDOM[4'hD][23];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :185:19
        frm = _RANDOM[4'hD][26:24];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :187:20
      `endif // RANDOMIZE_REG_INIT
    end // initial
