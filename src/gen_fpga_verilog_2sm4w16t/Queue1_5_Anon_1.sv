...
module Queue1_5_Anon_1(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  reg  [42:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  wire        do_enq = ~(~full & io_deq_ready) & io_enq_ready_0 & io_enq_valid;	// src/main/scala/chisel3/util/Decoupled.scala:259:27, :261:28, :263:27, :286:16, :298:17, :301:{26,35}, :306:{24,39}
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:263:27, :298:17, :301:{26,35}
      ram <= {io_enq_bits_wg_id, io_enq_bits_addr, io_enq_bits_cu_id};	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Decoupled.scala:243:7
        ...
        ram = {_RANDOM[1'h0][31:1], _RANDOM[1'h1][11:0]};	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  ...
  assign io_deq_bits_addr = full ? ram[10:1] : io_enq_bits_addr;	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :259:27, :293:17, :298:17, :299:19
  assign io_deq_bits_wg_id = full ? ram[42:11] : io_enq_bits_wg_id;	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :259:27, :293:17, :298:17, :299:19
endmodule
