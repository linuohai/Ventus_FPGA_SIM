...
module MSHRv2(	// ventus/src/pipeline/MSHR.scala:22:7
  ...
  wire [166:0] _tag_ext_R0_data;	// ventus/src/pipeline/MSHR.scala:32:16
  ...
  wire [3:0]   complete =
    {currentMask_3 == 16'h0, _complete_T_2, _complete_T_1, _complete_T} & used;	// ventus/src/pipeline/MSHR.scala:34:{28,36}, :36:21, :37:{43,52,59}
  ...
  always @(posedge clock) begin	// ventus/src/pipeline/MSHR.scala:22:7
    if (reset) begin	// ventus/src/pipeline/MSHR.scala:22:7
      ...
      used <= 4'h0;	// ventus/src/pipeline/MSHR.scala:22:7, :36:21
      ...
      if (|state) begin	// ventus/src/pipeline/MSHR.scala:43:22, :45:32
        ...
        if (_GEN_2)	// ventus/src/pipeline/MSHR.scala:63:19
          used <= used | 4'h1 << _GEN_3;	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :62:45, :85:26
        else if (_GEN_7 & io_to_pipe_ready & io_to_pipe_valid_0)	// ventus/src/pipeline/MSHR.scala:36:21, :61:19, :67:16, :94:{28,34}, :106:36
          used <= ~(_used_T_14 | 4'h1 << output_entry);	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :38:25, :39:57, :94:48
        state <=
          {_GEN_7
        ...
        if (_GEN_1) begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35
          automatic logic [3:0][15:0] _GEN_8;	// ventus/src/pipeline/MSHR.scala:53:78
        ...
        used <= {4{~_GEN_1}} & {4{_io_idx_entry_T}} & 4'h1 << _GEN_3 | used;	// src/main/scala/chisel3/util/Decoupled.scala:51:35, ventus/src/pipeline/MSHR.scala:22:7, :36:21, :62:45, :69:32, :73:36, :74:{14,28}
      end
    end
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/pipeline/MSHR.scala:22:7
    ...
    initial begin	// ventus/src/pipeline/MSHR.scala:22:7
      automatic logic [31:0] _RANDOM[0:7];	// ventus/src/pipeline/MSHR.scala:22:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/pipeline/MSHR.scala:22:7
        for (logic [3:0] i = 4'h0; i < 4'h8; i += 4'h1) begin
          _RANDOM[i[2:0]] = `RANDOM;	// ventus/src/pipeline/MSHR.scala:22:7
        end	// ventus/src/pipeline/MSHR.scala:22:7
        currentMask_0 = _RANDOM[3'h0][15:0];	// ventus/src/pipeline/MSHR.scala:22:7, :34:28
        currentMask_1 = _RANDOM[3'h0][31:16];	// ventus/src/pipeline/MSHR.scala:22:7, :34:28
        currentMask_2 = _RANDOM[3'h1][15:0];	// ventus/src/pipeline/MSHR.scala:22:7, :34:28
        currentMask_3 = _RANDOM[3'h1][31:16];	// ventus/src/pipeline/MSHR.scala:22:7, :34:28
        used = _RANDOM[3'h2][3:0];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21
        reg_req_warp_id = _RANDOM[3'h2][5:4];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_wfd = _RANDOM[3'h2][6];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_wxd = _RANDOM[3'h2][7];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_reg_idxw = _RANDOM[3'h2][15:8];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_0 = _RANDOM[3'h2][16];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_1 = _RANDOM[3'h2][17];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_2 = _RANDOM[3'h2][18];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_3 = _RANDOM[3'h2][19];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_4 = _RANDOM[3'h2][20];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_5 = _RANDOM[3'h2][21];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_6 = _RANDOM[3'h2][22];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_7 = _RANDOM[3'h2][23];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_8 = _RANDOM[3'h2][24];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_9 = _RANDOM[3'h2][25];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_10 = _RANDOM[3'h2][26];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_11 = _RANDOM[3'h2][27];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_12 = _RANDOM[3'h2][28];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_13 = _RANDOM[3'h2][29];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_14 = _RANDOM[3'h2][30];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_mask_15 = _RANDOM[3'h2][31];	// ventus/src/pipeline/MSHR.scala:22:7, :36:21, :40:20
        reg_req_unsigned = _RANDOM[3'h3][0];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_isvec = _RANDOM[3'h3][1];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_0 = _RANDOM[3'h3][5:2];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_1 = _RANDOM[3'h3][9:6];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_2 = _RANDOM[3'h3][13:10];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_3 = _RANDOM[3'h3][17:14];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_4 = _RANDOM[3'h3][21:18];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_5 = _RANDOM[3'h3][25:22];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_6 = _RANDOM[3'h3][29:26];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_7 = {_RANDOM[3'h3][31:30], _RANDOM[3'h4][1:0]};	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_8 = _RANDOM[3'h4][5:2];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_9 = _RANDOM[3'h4][9:6];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_10 = _RANDOM[3'h4][13:10];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_11 = _RANDOM[3'h4][17:14];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_12 = _RANDOM[3'h4][21:18];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_13 = _RANDOM[3'h4][25:22];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_14 = _RANDOM[3'h4][29:26];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_wordOffset1H_15 = {_RANDOM[3'h4][31:30], _RANDOM[3'h5][1:0]};	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_isWrite = _RANDOM[3'h5][2];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_spike_info_sm_id = _RANDOM[3'h5][10:3];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_spike_info_pc = {_RANDOM[3'h5][31:11], _RANDOM[3'h6][10:0]};	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        reg_req_spike_info_inst = {_RANDOM[3'h6][31:11], _RANDOM[3'h7][10:0]};	// ventus/src/pipeline/MSHR.scala:22:7, :40:20
        state = _RANDOM[3'h7][12:11];	// ventus/src/pipeline/MSHR.scala:22:7, :40:20, :43:22
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  data_4x512 data_ext (	// ventus/src/pipeline/MSHR.scala:31:17
  ...
  tag_4x167 tag_ext (	// ventus/src/pipeline/MSHR.scala:32:16
    .R0_addr (output_entry),	// ventus/src/pipeline/MSHR.scala:38:25
    .R0_en   (1'h1),	// ventus/src/pipeline/MSHR.scala:22:7
    .R0_clk  (clock),
  ...
  assign io_to_pipe_bits_tag_warp_id = _tag_ext_R0_data[166:165];	// ventus/src/pipeline/MSHR.scala:22:7, :32:16, :107:45
