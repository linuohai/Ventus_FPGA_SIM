...
module wg_buffer(	// ventus/src/cta/wg_buffer.scala:35:7
  ...
  input  [2:0]  io_host_wg_new_bits_num_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  input  [10:0] io_host_wg_new_bits_num_sgpr,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  input  [10:0] io_host_wg_new_bits_num_sgpr_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
                io_host_wg_new_bits_num_vgpr_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  input  [16:0] io_host_wg_new_bits_num_pds_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  input  [4:0]  io_host_wg_new_bits_num_thread_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  output [2:0]  io_alloc_wg_new_bits_num_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  output [10:0] io_alloc_wg_new_bits_num_sgpr,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  output [4:0]  io_cuinterface_wg_new_bits_num_thread_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  output [10:0] io_cuinterface_wg_new_bits_num_wg_x,	// ventus/src/cta/wg_buffer.scala:36:14
                ...
                io_cuinterface_wg_new_bits_num_sgpr_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
                io_cuinterface_wg_new_bits_num_vgpr_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  output [16:0] io_cuinterface_wg_new_bits_num_pds_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  wire [237:0] _wgram2_ext_R0_data;	// ventus/src/cta/wg_buffer.scala:56:19
  wire [74:0]  _wgram1_ext_R0_data;	// ventus/src/cta/wg_buffer.scala:55:19
  wire [4:0]   wgram2_wr_data_num_thread_per_wf = io_host_wg_new_bits_num_thread_per_wf;	// ventus/src/cta/wg_buffer.scala:61:28
  ...
  wire [10:0]  wgram2_wr_data_num_sgpr_per_wf = io_host_wg_new_bits_num_sgpr_per_wf;	// ventus/src/cta/wg_buffer.scala:61:28
  wire [10:0]  wgram2_wr_data_num_vgpr_per_wf = io_host_wg_new_bits_num_vgpr_per_wf;	// ventus/src/cta/wg_buffer.scala:61:28
  wire [16:0]  wgram2_wr_data_num_pds_per_wf = io_host_wg_new_bits_num_pds_per_wf;	// ventus/src/cta/wg_buffer.scala:61:28
  ...
  reg  [2:0]   wgram1_rd_data_r_num_wf;	// ventus/src/cta/wg_buffer.scala:111:30
  reg  [10:0]  wgram1_rd_data_r_num_sgpr;	// ventus/src/cta/wg_buffer.scala:111:30
  reg  [10:0]  wgram1_rd_data_r_num_vgpr;	// ventus/src/cta/wg_buffer.scala:111:30
  ...
  reg  [4:0]   wgram2_rd_data_num_thread_per_wf;	// ventus/src/cta/wg_buffer.scala:133:33
  ...
  reg  [10:0]  wgram2_rd_data_num_sgpr_per_wf;	// ventus/src/cta/wg_buffer.scala:133:33
  reg  [10:0]  wgram2_rd_data_num_vgpr_per_wf;	// ventus/src/cta/wg_buffer.scala:133:33
  reg  [16:0]  wgram2_rd_data_num_pds_per_wf;	// ventus/src/cta/wg_buffer.scala:133:33
  ...
  always @(posedge clock) begin	// ventus/src/cta/wg_buffer.scala:35:7
    ...
    if (wgram1_rd_act) begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      wgram1_rd_data_r_num_wf <= _wgram1_ext_R0_data[2:0];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
      wgram1_rd_data_r_num_sgpr <= _wgram1_ext_R0_data[13:3];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
      wgram1_rd_data_r_num_vgpr <= _wgram1_ext_R0_data[24:14];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
      wgram1_rd_data_r_num_lds <= _wgram1_ext_R0_data[42:25];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
      wgram1_rd_data_r_wg_id <= _wgram1_ext_R0_data[74:43];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
    ...
    if (wgram_rd2_clear_act) begin	// ventus/src/cta/wg_buffer.scala:151:80
      wgram2_rd_data_num_thread_per_wf <= _wgram2_ext_R0_data[4:0];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_gds_base <= _wgram2_ext_R0_data[36:5];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_pds_base <= _wgram2_ext_R0_data[68:37];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_start_pc <= _wgram2_ext_R0_data[100:69];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_csr_kernel <= _wgram2_ext_R0_data[132:101];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_wg_x <= _wgram2_ext_R0_data[143:133];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_wg_y <= _wgram2_ext_R0_data[154:144];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_wg_z <= _wgram2_ext_R0_data[165:155];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_sgpr_per_wf <= _wgram2_ext_R0_data[176:166];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_vgpr_per_wf <= _wgram2_ext_R0_data[187:177];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_pds_per_wf <= _wgram2_ext_R0_data[204:188];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_useless <= _wgram2_ext_R0_data[205];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_wg_id <= _wgram2_ext_R0_data[237:206];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/cta/wg_buffer.scala:35:7
    ...
    initial begin	// ventus/src/cta/wg_buffer.scala:35:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/cta/wg_buffer.scala:35:7
        ...
        wgram1_rd_data_r_num_wf = _RANDOM[4'h0][19:17];	// ventus/src/cta/wg_buffer.scala:35:7, :57:28, :111:30
        wgram1_rd_data_r_num_sgpr = _RANDOM[4'h0][30:20];	// ventus/src/cta/wg_buffer.scala:35:7, :57:28, :111:30
        wgram1_rd_data_r_num_vgpr = {_RANDOM[4'h0][31], _RANDOM[4'h1][9:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :57:28, :111:30
        wgram1_rd_data_r_num_lds = _RANDOM[4'h1][27:10];	// ventus/src/cta/wg_buffer.scala:35:7, :111:30
        wgram1_rd_data_r_wg_id = {_RANDOM[4'h1][31:28], _RANDOM[4'h2][27:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :111:30
        wgram1_rd_data_addr = _RANDOM[4'h2][30:28];	// ventus/src/cta/wg_buffer.scala:35:7, :111:30, :112:38
        cuinterface_new_wg_valid_r = _RANDOM[4'h2][31];	// ventus/src/cta/wg_buffer.scala:35:7, :111:30, :128:43
        wgram2_rd_data_num_thread_per_wf = _RANDOM[4'h3][4:0];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_gds_base = {_RANDOM[4'h3][31:5], _RANDOM[4'h4][4:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_pds_base = {_RANDOM[4'h4][31:5], _RANDOM[4'h5][4:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_start_pc = {_RANDOM[4'h5][31:5], _RANDOM[4'h6][4:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_csr_kernel = {_RANDOM[4'h6][31:5], _RANDOM[4'h7][4:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_x = _RANDOM[4'h7][15:5];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_y = _RANDOM[4'h7][26:16];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_z = {_RANDOM[4'h7][31:27], _RANDOM[4'h8][5:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_sgpr_per_wf = _RANDOM[4'h8][16:6];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_vgpr_per_wf = _RANDOM[4'h8][27:17];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_pds_per_wf = {_RANDOM[4'h8][31:28], _RANDOM[4'h9][12:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_useless = _RANDOM[4'h9][13];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_wg_id = {_RANDOM[4'h9][31:14], _RANDOM[4'hA][13:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        alloc_result_wgid = {_RANDOM[4'hA][31:14], _RANDOM[4'hB][13:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33, :140:38
        wgram_rd2_clear_act_r1 = _RANDOM[4'hB][14];	// ventus/src/cta/wg_buffer.scala:35:7, :140:38, :141:41
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  wgram1_8x75 wgram1_ext (	// ventus/src/cta/wg_buffer.scala:55:19
  ...
  wgram2_8x238 wgram2_ext (	// ventus/src/cta/wg_buffer.scala:56:19
