...
module ListBuffer_1(	// ventus/src/L2cache/ListBuffer.scala:33:7
  ...
  input  [15:0]   io_push_bits_data_source,	// ventus/src/L2cache/ListBuffer.scala:35:14
  ...
  output [15:0]   io_data_source	// ventus/src/L2cache/ListBuffer.scala:35:14
);

  wire [1175:0] _data_ext_R0_data;	// ventus/src/L2cache/ListBuffer.scala:50:18
  ...
  data_32x1176 data_ext (	// ventus/src/L2cache/ListBuffer.scala:50:18
    .R0_addr (_head_ext_R0_data),	// ventus/src/L2cache/ListBuffer.scala:46:18
    .R0_en   (1'h1),	// ventus/src/L2cache/ListBuffer.scala:33:7
    .R0_clk  (clock),
  ...
  assign io_data_mask = _data_ext_R0_data[1175:1048];	// ventus/src/L2cache/ListBuffer.scala:33:7, :50:18, :91:63
  assign io_data_data = _data_ext_R0_data[1047:24];	// ventus/src/L2cache/ListBuffer.scala:33:7, :50:18, :91:63
  assign io_data_opcode = _data_ext_R0_data[23:21];	// ventus/src/L2cache/ListBuffer.scala:33:7, :50:18, :91:63
  assign io_data_put = _data_ext_R0_data[20:16];	// ventus/src/L2cache/ListBuffer.scala:33:7, :50:18, :91:63
  assign io_data_source = _data_ext_R0_data[15:0];	// ventus/src/L2cache/ListBuffer.scala:33:7, :50:18, :91:63
endmodule
