...
module CTA2warp(	// ventus/src/pipeline/CTA2warp.scala:45:7
  ...
  input  [2:0]  io_CTAreq_bits_dispatch2cu_wg_wf_count,	// ventus/src/pipeline/CTA2warp.scala:46:12
  input  [4:0]  io_CTAreq_bits_dispatch2cu_wf_size_dispatch,	// ventus/src/pipeline/CTA2warp.scala:46:12
  input  [10:0] io_CTAreq_bits_dispatch2cu_sgpr_base_dispatch,	// ventus/src/pipeline/CTA2warp.scala:46:12
  ...
  input  [4:0]  io_CTAreq_bits_dispatch2cu_wf_tag_dispatch,	// ventus/src/pipeline/CTA2warp.scala:46:12
  ...
  output [4:0]  io_CTArsp_bits_cu2dispatch_wf_tag_done,	// ventus/src/pipeline/CTA2warp.scala:46:12
  output        io_warpReq_valid,	// ventus/src/pipeline/CTA2warp.scala:46:12
  output [2:0]  io_warpReq_bits_CTAdata_dispatch2cu_wg_wf_count,	// ventus/src/pipeline/CTA2warp.scala:46:12
  output [4:0]  io_warpReq_bits_CTAdata_dispatch2cu_wf_size_dispatch,	// ventus/src/pipeline/CTA2warp.scala:46:12
  output [10:0] io_warpReq_bits_CTAdata_dispatch2cu_sgpr_base_dispatch,	// ventus/src/pipeline/CTA2warp.scala:46:12
  ...
  output [4:0]  io_warpReq_bits_CTAdata_dispatch2cu_wf_tag_dispatch,	// ventus/src/pipeline/CTA2warp.scala:46:12
  ...
  output [1:0]  io_warpReq_bits_wid,	// ventus/src/pipeline/CTA2warp.scala:46:12
  ...
  input  [1:0]  io_warpRsp_bits_wid,	// ventus/src/pipeline/CTA2warp.scala:46:12
                io_wg_id_lookup,	// ventus/src/pipeline/CTA2warp.scala:46:12
  output [4:0]  io_wg_id_tag	// ventus/src/pipeline/CTA2warp.scala:46:12
);

  wire            _CTArsp_fifo_q_io_enq_ready;	// src/main/scala/chisel3/util/Decoupled.scala:362:21
  wire [1:0]      _CTArsp_fifo_q_io_deq_bits_wid;	// src/main/scala/chisel3/util/Decoupled.scala:362:21
  reg  [3:0]      idx_using;	// ventus/src/pipeline/CTA2warp.scala:54:26
  wire            io_CTAreq_ready_0 = idx_using != 4'hF;	// ventus/src/pipeline/CTA2warp.scala:54:26, :56:32, :63:66
  reg  [4:0]      data_0;	// ventus/src/pipeline/CTA2warp.scala:57:17
  reg  [4:0]      data_1;	// ventus/src/pipeline/CTA2warp.scala:57:17
  reg  [4:0]      data_2;	// ventus/src/pipeline/CTA2warp.scala:57:17
  reg  [4:0]      data_3;	// ventus/src/pipeline/CTA2warp.scala:57:17
  wire [3:0][4:0] _GEN = {{data_3}, {data_2}, {data_1}, {data_0}};	// ventus/src/pipeline/CTA2warp.scala:57:17, :58:15
  wire [2:0]      _idx_next_allocate_T = ~(idx_using[2:0]);	// ventus/src/pipeline/CTA2warp.scala:54:26, :59:43
  wire [1:0]      idx_next_allocate =
    _idx_next_allocate_T[0]
      ? 2'h0
      : _idx_next_allocate_T[1] ? 2'h1 : {1'h1, ~(_idx_next_allocate_T[2])};	// src/main/scala/chisel3/util/Mux.scala:50:70, src/main/scala/chisel3/util/OneHot.scala:48:45, ventus/src/pipeline/CTA2warp.scala:45:7, :59:43, :65:28
  ...
  always @(posedge clock) begin	// ventus/src/pipeline/CTA2warp.scala:45:7
    if (reset)	// ventus/src/pipeline/CTA2warp.scala:45:7
      idx_using <= 4'h0;	// ventus/src/pipeline/CTA2warp.scala:54:26
    else	// ventus/src/pipeline/CTA2warp.scala:45:7
      idx_using <=
        (idx_using | 4'h1 << idx_next_allocate & {4{io_warpReq_valid_0}})
        & ~({4{_CTArsp_fifo_q_io_enq_ready & io_warpRsp_valid}} & 4'h1
    ...
    if (io_warpReq_valid_0 & idx_next_allocate == 2'h0)	// src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/chisel3/util/Mux.scala:50:70, ventus/src/pipeline/CTA2warp.scala:57:17, :64:24, :65:28
      data_0 <= io_CTAreq_bits_dispatch2cu_wf_tag_dispatch;	// ventus/src/pipeline/CTA2warp.scala:57:17
    if (io_warpReq_valid_0 & idx_next_allocate == 2'h1)	// src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/chisel3/util/Mux.scala:50:70, ventus/src/pipeline/CTA2warp.scala:57:17, :64:24, :65:28
      data_1 <= io_CTAreq_bits_dispatch2cu_wf_tag_dispatch;	// ventus/src/pipeline/CTA2warp.scala:57:17
    if (io_warpReq_valid_0 & idx_next_allocate == 2'h2)	// src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/chisel3/util/Mux.scala:50:70, ventus/src/pipeline/CTA2warp.scala:57:17, :64:24, :65:28
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/pipeline/CTA2warp.scala:45:7
    ...
    initial begin	// ventus/src/pipeline/CTA2warp.scala:45:7
      automatic logic [31:0] _RANDOM[0:0];	// ventus/src/pipeline/CTA2warp.scala:45:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/pipeline/CTA2warp.scala:45:7
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// ventus/src/pipeline/CTA2warp.scala:45:7
        idx_using = _RANDOM[/*Zero width*/ 1'b0][3:0];	// ventus/src/pipeline/CTA2warp.scala:45:7, :54:26
        data_0 = _RANDOM[/*Zero width*/ 1'b0][8:4];	// ventus/src/pipeline/CTA2warp.scala:45:7, :54:26, :57:17
        data_1 = _RANDOM[/*Zero width*/ 1'b0][13:9];	// ventus/src/pipeline/CTA2warp.scala:45:7, :54:26, :57:17
        data_2 = _RANDOM[/*Zero width*/ 1'b0][18:14];	// ventus/src/pipeline/CTA2warp.scala:45:7, :54:26, :57:17
        data_3 = _RANDOM[/*Zero width*/ 1'b0][23:19];	// ventus/src/pipeline/CTA2warp.scala:45:7, :54:26, :57:17
      `endif // RANDOMIZE_REG_INIT
    end // initial
