...
module Queue1_io_alloc2cuinterface(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  reg  [41:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Decoupled.scala:243:7
        ...
        ram = {_RANDOM[1'h0][31:1], _RANDOM[1'h1][10:0]};	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  ...
  assign io_deq_bits_cu_id = ram[0];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wg_slot_id = ram[3:1];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_num_wf = ram[6:4];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_lds_dealloc_en = ram[7];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_sgpr_dealloc_en = ram[8];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_vgpr_dealloc_en = ram[9];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wg_id = ram[41:10];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
endmodule
