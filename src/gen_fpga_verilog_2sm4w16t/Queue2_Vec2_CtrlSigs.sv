...
module Queue2_Vec2_CtrlSigs(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  input  [7:0]  io_enq_bits_0_spike_info_sm_id,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  ...
  input  [7:0]  io_enq_bits_1_spike_info_sm_id,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  ...
  ram_2x454 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    ...
    .W0_data
      ({3'h0,
        ...
        io_enq_bits_0_fp,
        io_enq_bits_0_wid,
        io_enq_bits_0_inst})	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  );
