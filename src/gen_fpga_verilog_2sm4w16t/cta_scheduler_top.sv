...
module cta_scheduler_top(	// ventus/src/cta/cta_scheduler.scala:106:7
  ...
  input  [16:0] io_host_wg_new_bits_num_pds_per_wf,	// ventus/src/cta/cta_scheduler.scala:108:14
  input  [4:0]  io_host_wg_new_bits_num_thread_per_wf,	// ventus/src/cta/cta_scheduler.scala:108:14
  ...
  output        io_cu_wf_done_1_ready,	// ventus/src/cta/cta_scheduler.scala:108:14
  input         io_cu_wf_done_1_valid,	// ventus/src/cta/cta_scheduler.scala:108:14
  input  [4:0]  io_cu_wf_done_1_bits_wf_tag,	// ventus/src/cta/cta_scheduler.scala:108:14
  ...
  output [4:0]  io_cu_wf_new_0_bits_num_thread_per_wf,	// ventus/src/cta/cta_scheduler.scala:108:14
  ...
  input         io_cu_wf_new_1_ready,	// ventus/src/cta/cta_scheduler.scala:108:14
  output        io_cu_wf_new_1_valid,	// ventus/src/cta/cta_scheduler.scala:108:14
  output [4:0]  io_cu_wf_new_1_bits_num_thread_per_wf,	// ventus/src/cta/cta_scheduler.scala:108:14
  output [31:0] io_cu_wf_new_1_bits_pds_base,	// ventus/src/cta/cta_scheduler.scala:108:14
                io_cu_wf_new_1_bits_start_pc,	// ventus/src/cta/cta_scheduler.scala:108:14
                io_cu_wf_new_1_bits_csr_kernel,	// ventus/src/cta/cta_scheduler.scala:108:14
  output [10:0] io_cu_wf_new_1_bits_num_wg_x,	// ventus/src/cta/cta_scheduler.scala:108:14
                io_cu_wf_new_1_bits_num_wg_y,	// ventus/src/cta/cta_scheduler.scala:108:14
                io_cu_wf_new_1_bits_num_wg_z,	// ventus/src/cta/cta_scheduler.scala:108:14
  output [9:0]  io_cu_wf_new_1_bits_sgpr_base,	// ventus/src/cta/cta_scheduler.scala:108:14
                io_cu_wf_new_1_bits_vgpr_base,	// ventus/src/cta/cta_scheduler.scala:108:14
  output [16:0] io_cu_wf_new_1_bits_lds_base,	// ventus/src/cta/cta_scheduler.scala:108:14
  output [31:0] io_cu_wf_new_1_bits_wg_id,	// ventus/src/cta/cta_scheduler.scala:108:14
  output [4:0]  io_cu_wf_new_1_bits_wf_tag,	// ventus/src/cta/cta_scheduler.scala:108:14
  output [2:0]  io_cu_wf_new_1_bits_num_wf	// ventus/src/cta/cta_scheduler.scala:108:14
);
  ...
  wire        _cu_interface_inst_io_rt_dealloc_bits_cu_id;	// ventus/src/cta/cta_scheduler.scala:121:33
  ...
  wire        _resource_table_inst_io_slot_dealloc_bits_cu_id;	// ventus/src/cta/cta_scheduler.scala:120:35
  ...
  wire        _resource_table_inst_io_rtcache_lds_bits_cu_id;	// ventus/src/cta/cta_scheduler.scala:120:35
  ...
  wire        _resource_table_inst_io_rtcache_sgpr_bits_cu_id;	// ventus/src/cta/cta_scheduler.scala:120:35
  ...
  wire        _resource_table_inst_io_rtcache_vgpr_bits_cu_id;	// ventus/src/cta/cta_scheduler.scala:120:35
  ...
  wire        _allocator_inst_io_cuinterface_wg_new_bits_cu_id;	// ventus/src/cta/cta_scheduler.scala:119:30
  ...
  wire        _allocator_inst_io_rt_alloc_bits_cu_id;	// ventus/src/cta/cta_scheduler.scala:119:30
  ...
  wire        _allocator_inst_io_rt_dealloc_ready;	// ventus/src/cta/cta_scheduler.scala:119:30
  ...
  wire [4:0]  _wg_buffer_inst_io_cuinterface_wg_new_bits_num_thread_per_wf;	// ventus/src/cta/cta_scheduler.scala:118:30
  ...
  wire [16:0] _wg_buffer_inst_io_cuinterface_wg_new_bits_num_pds_per_wf;	// ventus/src/cta/cta_scheduler.scala:118:30
  ...
  allocator allocator_inst (	// ventus/src/cta/cta_scheduler.scala:119:30
    ...
    .io_cuinterface_wg_new_bits_cu_id
      (_allocator_inst_io_cuinterface_wg_new_bits_cu_id),
    ...
    .io_rt_alloc_bits_cu_id                     (_allocator_inst_io_rt_alloc_bits_cu_id),
    ...
    .io_rt_dealloc_ready                        (_allocator_inst_io_rt_dealloc_ready),
    .io_rt_dealloc_valid
      (_resource_table_inst_io_slot_dealloc_valid),	// ventus/src/cta/cta_scheduler.scala:120:35
    .io_rt_dealloc_bits_cu_id
      (_resource_table_inst_io_slot_dealloc_bits_cu_id),	// ventus/src/cta/cta_scheduler.scala:120:35
    ...
    .io_rt_result_lds_bits_cu_id
      (_resource_table_inst_io_rtcache_lds_bits_cu_id),	// ventus/src/cta/cta_scheduler.scala:120:35
    ...
    .io_rt_result_sgpr_bits_cu_id
      (_resource_table_inst_io_rtcache_sgpr_bits_cu_id),	// ventus/src/cta/cta_scheduler.scala:120:35
    ...
    .io_rt_result_vgpr_bits_cu_id
      (_resource_table_inst_io_rtcache_vgpr_bits_cu_id)	// ventus/src/cta/cta_scheduler.scala:120:35
  );
  resource_table_top resource_table_inst (	// ventus/src/cta/cta_scheduler.scala:120:35
    ...
    .io_alloc_bits_cu_id                  (_allocator_inst_io_rt_alloc_bits_cu_id),	// ventus/src/cta/cta_scheduler.scala:119:30
    ...
    .io_dealloc_bits_cu_id                (_cu_interface_inst_io_rt_dealloc_bits_cu_id),	// ventus/src/cta/cta_scheduler.scala:121:33
    ...
    .io_slot_dealloc_ready                (_allocator_inst_io_rt_dealloc_ready),	// ventus/src/cta/cta_scheduler.scala:119:30
    .io_slot_dealloc_valid                (_resource_table_inst_io_slot_dealloc_valid),
    .io_slot_dealloc_bits_cu_id
      (_resource_table_inst_io_slot_dealloc_bits_cu_id),
    ...
    .io_rtcache_lds_bits_cu_id
      (_resource_table_inst_io_rtcache_lds_bits_cu_id),
    ...
    .io_rtcache_sgpr_bits_cu_id
      (_resource_table_inst_io_rtcache_sgpr_bits_cu_id),
    ...
    .io_rtcache_vgpr_bits_cu_id
      (_resource_table_inst_io_rtcache_vgpr_bits_cu_id),
  ...
  cu_interface cu_interface_inst (	// ventus/src/cta/cta_scheduler.scala:121:33
    ...
    .io_alloc_wg_new_bits_cu_id
      (_allocator_inst_io_cuinterface_wg_new_bits_cu_id),	// ventus/src/cta/cta_scheduler.scala:119:30
    ...
    .io_cu_wf_new_1_ready                      (io_cu_wf_new_1_ready),
    .io_cu_wf_new_1_valid                      (io_cu_wf_new_1_valid),
    .io_cu_wf_new_1_bits_num_thread_per_wf     (io_cu_wf_new_1_bits_num_thread_per_wf),
    .io_cu_wf_new_1_bits_pds_base              (io_cu_wf_new_1_bits_pds_base),
    .io_cu_wf_new_1_bits_start_pc              (io_cu_wf_new_1_bits_start_pc),
    .io_cu_wf_new_1_bits_csr_kernel            (io_cu_wf_new_1_bits_csr_kernel),
    .io_cu_wf_new_1_bits_num_wg_x              (io_cu_wf_new_1_bits_num_wg_x),
    .io_cu_wf_new_1_bits_num_wg_y              (io_cu_wf_new_1_bits_num_wg_y),
    .io_cu_wf_new_1_bits_num_wg_z              (io_cu_wf_new_1_bits_num_wg_z),
    .io_cu_wf_new_1_bits_sgpr_base             (io_cu_wf_new_1_bits_sgpr_base),
    .io_cu_wf_new_1_bits_vgpr_base             (io_cu_wf_new_1_bits_vgpr_base),
    .io_cu_wf_new_1_bits_lds_base              (io_cu_wf_new_1_bits_lds_base),
    .io_cu_wf_new_1_bits_wg_id                 (io_cu_wf_new_1_bits_wg_id),
    .io_cu_wf_new_1_bits_wf_tag                (io_cu_wf_new_1_bits_wf_tag),
    .io_cu_wf_new_1_bits_num_wf                (io_cu_wf_new_1_bits_num_wf),
    ...
    .io_cu_wf_done_1_ready                     (io_cu_wf_done_1_ready),
    .io_cu_wf_done_1_valid                     (io_cu_wf_done_1_valid),
    .io_cu_wf_done_1_bits_wf_tag               (io_cu_wf_done_1_bits_wf_tag),
    ...
    .io_rt_dealloc_bits_cu_id
      (_cu_interface_inst_io_rt_dealloc_bits_cu_id),
    .io_rt_dealloc_bits_wg_slot_id
