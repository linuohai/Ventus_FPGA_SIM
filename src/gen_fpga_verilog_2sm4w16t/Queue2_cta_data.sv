...
module Queue2_cta_data(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  input         io_enq_valid,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
                io_enq_bits_cu_id,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input  [2:0]  io_enq_bits_wg_slot_id,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
                io_enq_bits_num_wf,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  ...
  output        io_deq_valid,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
                io_deq_bits_cu_id,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [2:0]  io_deq_bits_wg_slot_id,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
                io_deq_bits_num_wf,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  ...
  ram_2x252 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    ...
    .W0_data
      ({io_enq_bits_wg_id,
        ...
        io_enq_bits_num_wf,
        io_enq_bits_wg_slot_id,
        io_enq_bits_cu_id})	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  );
  ...
  assign io_deq_bits_cu_id = _ram_ext_R0_data[0];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wg_slot_id = _ram_ext_R0_data[3:1];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_num_wf = _ram_ext_R0_data[6:4];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
