...
module Queue1_MSHRmissRspOut(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  input          clock,	// src/main/scala/chisel3/util/Decoupled.scala:243:7
                 reset,	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  output         io_enq_ready,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input          io_enq_valid,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input  [161:0] io_enq_bits_targetInfo,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input  [24:0]  io_enq_bits_blockAddr,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input  [1:0]   io_enq_bits_instrId,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input          io_deq_ready,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output         io_deq_valid,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [161:0] io_deq_bits_targetInfo,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [24:0]  io_deq_bits_blockAddr	// src/main/scala/chisel3/util/Decoupled.scala:255:14
);

  reg  [188:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      ram <= {io_enq_bits_instrId, io_enq_bits_blockAddr, io_enq_bits_targetInfo};	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Decoupled.scala:243:7
        ...
        ram =
          {_RANDOM[3'h0][31:1],
           ...
           _RANDOM[3'h3],
           _RANDOM[3'h4],
           _RANDOM[3'h5][29:0]};	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  ...
  assign io_deq_bits_targetInfo = ram[161:0];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_blockAddr = ram[186:162];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
endmodule
