...
module SRAMTemplate(	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
  ...
  wire [16:0] mem_rdata_0 =
    bypass_mask[0] ? bypass_wdata_lfsr[16:0] : _array_R0_data[16:0];	// ventus/src/SRAMTemplate/LFSR64.scala:20:23, ventus/src/SRAMTemplate/SRAMTemplate.scala:96:26, :125:67, :129:58, :133:30, :134:30
  wire [16:0] mem_rdata_1 =
    bypass_mask[1] ? bypass_wdata_lfsr_1[16:0] : _array_R0_data[33:17];	// ventus/src/SRAMTemplate/LFSR64.scala:20:23, ventus/src/SRAMTemplate/SRAMTemplate.scala:96:26, :125:67, :129:58, :133:30, :134:30
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
    ...
    initial begin	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
      automatic logic [31:0] _RANDOM[0:5];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
        ...
        rdata_REG = _RANDOM[3'h4][19];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :121:29, :139:59
        rdata_r_0 = {_RANDOM[3'h4][31:20], _RANDOM[3'h5][4:0]};	// ventus/src/SRAMTemplate/Hold.scala:18:65, ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :121:29
        rdata_r_1 = _RANDOM[3'h5][21:5];	// ventus/src/SRAMTemplate/Hold.scala:18:65, ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  array array (	// ventus/src/SRAMTemplate/SRAMTemplate.scala:96:26
