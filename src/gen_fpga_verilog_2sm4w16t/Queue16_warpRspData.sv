...
module Queue16_warpRspData(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  ram_wid_16x2 ram_wid_ext (	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    .R0_addr (deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40
    .R0_en   (1'h1),	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    .R0_clk  (clock),
    .R0_data (io_deq_bits_wid),
