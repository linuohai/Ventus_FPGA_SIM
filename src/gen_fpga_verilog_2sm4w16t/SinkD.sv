...
module SinkD(	// ventus/src/L2cache/SinkD.scala:37:7
  ...
  output [15:0]   io_resp_bits_source,	// ventus/src/L2cache/SinkD.scala:39:14
  ...
  input  [15:0]   io_d_bits_source,	// ventus/src/L2cache/SinkD.scala:39:14
  ...
  reg [15:0]   io_resp_bits_source_REG;	// ventus/src/L2cache/SinkD.scala:69:33
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/L2cache/SinkD.scala:37:7
    ...
    initial begin	// ventus/src/L2cache/SinkD.scala:37:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/L2cache/SinkD.scala:37:7
        ...
        io_resp_valid_REG = _RANDOM[6'h0][16];	// ventus/src/L2cache/SinkD.scala:37:7, :65:33
        io_resp_bits_opcode_REG = _RANDOM[6'h0][19:17];	// ventus/src/L2cache/SinkD.scala:37:7, :65:33, :68:33
        io_resp_bits_source_REG = {_RANDOM[6'h0][31:20], _RANDOM[6'h1][3:0]};	// ventus/src/L2cache/SinkD.scala:37:7, :65:33, :69:33
        io_resp_bits_data_REG =
          {_RANDOM[6'h1][31:4],
           ...
           _RANDOM[6'h1F],
           _RANDOM[6'h20],
           _RANDOM[6'h21][3:0]};	// ventus/src/L2cache/SinkD.scala:37:7, :69:33, :70:33
      `endif // RANDOMIZE_REG_INIT
    end // initial
