...
module ram_2x1269(	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  input           R0_addr,
                  R0_en,
                  R0_clk,
  output [1268:0] R0_data,
  input           W0_addr,
                  W0_en,
                  W0_clk,
  input  [1268:0] W0_data
);

  reg [1268:0] Memory[0:1];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  `ifdef ENABLE_INITIAL_MEM_	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    reg [1279:0] _RANDOM_MEM;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:256:91
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          for (logic [10:0] j = 11'h0; j < 11'h500; j += 11'h20) begin
          ...
          Memory[i[0]] = _RANDOM_MEM[1268:0];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
        end	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 1269'bx;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
endmodule
