...
module CTAinterface(	// ventus/src/top/GPGPU_top.scala:53:7
  ...
  input  [2:0]  io_host2CTA_bits_host_num_wf,	// ventus/src/top/GPGPU_top.scala:54:12
  ...
  output [2:0]  io_CTA2warp_0_bits_dispatch2cu_wg_wf_count,	// ventus/src/top/GPGPU_top.scala:54:12
  output [4:0]  io_CTA2warp_0_bits_dispatch2cu_wf_size_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
  output [10:0] io_CTA2warp_0_bits_dispatch2cu_sgpr_base_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
  ...
  output [4:0]  io_CTA2warp_0_bits_dispatch2cu_wf_tag_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
  ...
  input         io_CTA2warp_1_ready,	// ventus/src/top/GPGPU_top.scala:54:12
  output        io_CTA2warp_1_valid,	// ventus/src/top/GPGPU_top.scala:54:12
  output [2:0]  io_CTA2warp_1_bits_dispatch2cu_wg_wf_count,	// ventus/src/top/GPGPU_top.scala:54:12
  output [4:0]  io_CTA2warp_1_bits_dispatch2cu_wf_size_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
  output [10:0] io_CTA2warp_1_bits_dispatch2cu_sgpr_base_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
                io_CTA2warp_1_bits_dispatch2cu_vgpr_base_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
  output [17:0] io_CTA2warp_1_bits_dispatch2cu_lds_base_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
  output [4:0]  io_CTA2warp_1_bits_dispatch2cu_wf_tag_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
  output [31:0] io_CTA2warp_1_bits_dispatch2cu_start_pc_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
                io_CTA2warp_1_bits_dispatch2cu_pds_base_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
                io_CTA2warp_1_bits_dispatch2cu_csr_knl_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
  output [10:0] io_CTA2warp_1_bits_dispatch2cu_wgid_x_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
                io_CTA2warp_1_bits_dispatch2cu_wgid_y_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
                io_CTA2warp_1_bits_dispatch2cu_wgid_z_dispatch,	// ventus/src/top/GPGPU_top.scala:54:12
  output [31:0] io_CTA2warp_1_bits_dispatch2cu_wg_id,	// ventus/src/top/GPGPU_top.scala:54:12
  ...
  input  [4:0]  io_warp2CTA_0_bits_cu2dispatch_wf_tag_done,	// ventus/src/top/GPGPU_top.scala:54:12
  output        io_warp2CTA_1_ready,	// ventus/src/top/GPGPU_top.scala:54:12
  input         io_warp2CTA_1_valid,	// ventus/src/top/GPGPU_top.scala:54:12
  input  [4:0]  io_warp2CTA_1_bits_cu2dispatch_wf_tag_done	// ventus/src/top/GPGPU_top.scala:54:12
);

  wire [9:0]  _cta_sche_io_cu_wf_new_0_bits_sgpr_base;	// ventus/src/top/GPGPU_top.scala:60:24
  ...
  wire [9:0]  _cta_sche_io_cu_wf_new_1_bits_sgpr_base;	// ventus/src/top/GPGPU_top.scala:60:24
  wire [9:0]  _cta_sche_io_cu_wf_new_1_bits_vgpr_base;	// ventus/src/top/GPGPU_top.scala:60:24
  wire [16:0] _cta_sche_io_cu_wf_new_1_bits_lds_base;	// ventus/src/top/GPGPU_top.scala:60:24
  cta_scheduler_top cta_sche (	// ventus/src/top/GPGPU_top.scala:60:24
    ...
    .io_cu_wf_done_1_ready                 (io_warp2CTA_1_ready),
    .io_cu_wf_done_1_valid                 (io_warp2CTA_1_valid),
    .io_cu_wf_done_1_bits_wf_tag           (io_warp2CTA_1_bits_cu2dispatch_wf_tag_done),
    ...
    .io_cu_wf_new_1_ready                  (io_CTA2warp_1_ready),
    .io_cu_wf_new_1_valid                  (io_CTA2warp_1_valid),
    .io_cu_wf_new_1_bits_num_thread_per_wf
      (io_CTA2warp_1_bits_dispatch2cu_wf_size_dispatch),
    .io_cu_wf_new_1_bits_pds_base
      (io_CTA2warp_1_bits_dispatch2cu_pds_base_dispatch),
    .io_cu_wf_new_1_bits_start_pc
      (io_CTA2warp_1_bits_dispatch2cu_start_pc_dispatch),
    .io_cu_wf_new_1_bits_csr_kernel
      (io_CTA2warp_1_bits_dispatch2cu_csr_knl_dispatch),
    .io_cu_wf_new_1_bits_num_wg_x
      (io_CTA2warp_1_bits_dispatch2cu_wgid_x_dispatch),
    .io_cu_wf_new_1_bits_num_wg_y
      (io_CTA2warp_1_bits_dispatch2cu_wgid_y_dispatch),
    .io_cu_wf_new_1_bits_num_wg_z
      (io_CTA2warp_1_bits_dispatch2cu_wgid_z_dispatch),
    .io_cu_wf_new_1_bits_sgpr_base         (_cta_sche_io_cu_wf_new_1_bits_sgpr_base),
    .io_cu_wf_new_1_bits_vgpr_base         (_cta_sche_io_cu_wf_new_1_bits_vgpr_base),
    .io_cu_wf_new_1_bits_lds_base          (_cta_sche_io_cu_wf_new_1_bits_lds_base),
    .io_cu_wf_new_1_bits_wg_id             (io_CTA2warp_1_bits_dispatch2cu_wg_id),
    .io_cu_wf_new_1_bits_wf_tag
      (io_CTA2warp_1_bits_dispatch2cu_wf_tag_dispatch),
    .io_cu_wf_new_1_bits_num_wf            (io_CTA2warp_1_bits_dispatch2cu_wg_wf_count)
  );
  ...
  assign io_CTA2warp_1_bits_dispatch2cu_sgpr_base_dispatch =
    {1'h0, _cta_sche_io_cu_wf_new_1_bits_sgpr_base};	// ventus/src/top/GPGPU_top.scala:53:7, :60:24, :91:56, :92:56
  assign io_CTA2warp_1_bits_dispatch2cu_vgpr_base_dispatch =
    {1'h0, _cta_sche_io_cu_wf_new_1_bits_vgpr_base};	// ventus/src/top/GPGPU_top.scala:53:7, :60:24, :91:56, :93:56
  assign io_CTA2warp_1_bits_dispatch2cu_lds_base_dispatch =
    {1'h0, _cta_sche_io_cu_wf_new_1_bits_lds_base};	// ventus/src/top/GPGPU_top.scala:53:7, :60:24, :91:56
endmodule
