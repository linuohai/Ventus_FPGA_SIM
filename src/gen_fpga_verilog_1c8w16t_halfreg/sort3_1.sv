...
module sort3_1(	// ventus/src/cta/utils.scala:56:7
  ...
  input  [11:0] io_in_0,	// ventus/src/cta/utils.scala:57:14
                io_in_1,	// ventus/src/cta/utils.scala:57:14
                io_in_2,	// ventus/src/cta/utils.scala:57:14
  output [11:0] io_out_0,	// ventus/src/cta/utils.scala:57:14
  ...
  wire [11:0] _io_out_0_T_15 =
    ((&_io_out_2_T) ? io_in_0 : 12'h0) | ((&_io_out_2_T_3) ? io_in_1 : 12'h0)
    | ((&_io_out_2_T_6) ? io_in_2 : 12'h0) | (_io_out_2_T_9 | cmp2 ? 12'h0 : io_in_0);	// src/main/scala/chisel3/util/Mux.scala:30:73, ventus/src/cta/utils.scala:63:23, :72:{12,19}, :73:{12,19}, :74:{12,19}, :75:{17,30}
  wire [11:0] _io_out_1_T_10 =
    (^_io_out_2_T ? io_in_0 : 12'h0) | (^_io_out_2_T_3 ? io_in_1 : 12'h0)
    | (^_io_out_2_T_6 ? io_in_2 : 12'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, ventus/src/cta/utils.scala:72:12, :73:12, :74:12, :78:19, :79:19, :80:19
  `ifndef SYNTHESIS	// ventus/src/cta/utils.scala:89:9
    always @(posedge clock) begin	// ventus/src/cta/utils.scala:89:9
      automatic logic [11:0] _io_out_2_T_18 =
        (_io_out_2_T == 2'h0 ? io_in_0 : 12'h0)
        | (_io_out_2_T_3 == 2'h0 ? io_in_1 : 12'h0)
        | (_io_out_2_T_6 == 2'h0 ? io_in_2 : 12'h0)
        | (_io_out_2_T_9 | cmp2 ? 12'h0 : io_in_0);	// src/main/scala/chisel3/util/Mux.scala:30:73, ventus/src/cta/utils.scala:63:23, :72:12, :73:12, :74:12, :75:17, :83:20, :84:20, :85:20, :86:30
      if (~reset
