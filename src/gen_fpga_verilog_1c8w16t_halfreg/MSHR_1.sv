...
module MSHR_1(	// ventus/src/L1Cache/L1MSHR.scala:79:7
  ...
  input  [162:0] io_missReq_bits_targetInfo,	// ventus/src/L1Cache/L1MSHR.scala:80:14
  ...
  output [162:0] io_missRspOut_bits_targetInfo,	// ventus/src/L1Cache/L1MSHR.scala:80:14
  ...
  reg  [162:0]      targetInfo_Accesss_0_0;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [162:0]      targetInfo_Accesss_0_1;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [162:0]      targetInfo_Accesss_1_0;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [162:0]      targetInfo_Accesss_1_1;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [162:0]      targetInfo_Accesss_2_0;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [162:0]      targetInfo_Accesss_2_1;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [162:0]      targetInfo_Accesss_3_0;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [162:0]      targetInfo_Accesss_3_1;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  ...
  always @(posedge clock) begin	// ventus/src/L1Cache/L1MSHR.scala:79:7
    if (reset) begin	// ventus/src/L1Cache/L1MSHR.scala:79:7
      ...
      targetInfo_Accesss_0_0 <= 163'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_0_1 <= 163'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_1_0 <= 163'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_1_1 <= 163'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_2_0 <= 163'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_2_1 <= 163'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_3_0 <= 163'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_3_1 <= 163'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/L1Cache/L1MSHR.scala:79:7
        ...
        targetInfo_Accesss_0_0 =
          {_RANDOM[6'h3][31:16],
           ...
           _RANDOM[6'h6],
           _RANDOM[6'h7],
           _RANDOM[6'h8][18:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :100:33, :102:35
        targetInfo_Accesss_0_1 =
          {_RANDOM[6'h8][31:19],
           ...
           _RANDOM[6'hB],
           _RANDOM[6'hC],
           _RANDOM[6'hD][21:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_1_0 =
          {_RANDOM[6'hD][31:22],
           _RANDOM[6'hE],
           _RANDOM[6'hF],
           _RANDOM[6'h10],
           _RANDOM[6'h11],
           _RANDOM[6'h12][24:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_1_1 =
          {_RANDOM[6'h12][31:25],
           _RANDOM[6'h13],
           _RANDOM[6'h14],
           _RANDOM[6'h15],
           _RANDOM[6'h16],
           _RANDOM[6'h17][27:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_2_0 =
          {_RANDOM[6'h17][31:28],
           _RANDOM[6'h18],
           _RANDOM[6'h19],
           _RANDOM[6'h1A],
           _RANDOM[6'h1B],
           _RANDOM[6'h1C][30:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_2_1 =
          {_RANDOM[6'h1C][31],
           _RANDOM[6'h1D],
           _RANDOM[6'h1E],
           ...
           _RANDOM[6'h20],
           _RANDOM[6'h21],
           _RANDOM[6'h22][1:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_3_0 =
          {_RANDOM[6'h22][31:2],
           _RANDOM[6'h23],
           _RANDOM[6'h24],
           _RANDOM[6'h25],
           _RANDOM[6'h26],
           _RANDOM[6'h27][4:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_3_1 =
          {_RANDOM[6'h27][31:5],
           _RANDOM[6'h28],
           _RANDOM[6'h29],
           _RANDOM[6'h2A],
           _RANDOM[6'h2B],
           _RANDOM[6'h2C][7:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        subentry_valid_0_0 = _RANDOM[6'h2C][8];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        subentry_valid_0_1 = _RANDOM[6'h2C][9];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        subentry_valid_1_0 = _RANDOM[6'h2C][10];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        subentry_valid_1_1 = _RANDOM[6'h2C][11];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        subentry_valid_2_0 = _RANDOM[6'h2C][12];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        subentry_valid_2_1 = _RANDOM[6'h2C][13];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        subentry_valid_3_0 = _RANDOM[6'h2C][14];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        subentry_valid_3_1 = _RANDOM[6'h2C][15];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        releasing_stall_0 = _RANDOM[6'h2C][17];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :109:32
        releasing_stall_1 = _RANDOM[6'h2C][18];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :109:32
        releasing_stall_2 = _RANDOM[6'h2C][19];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :109:32
        releasing_stall_3 = _RANDOM[6'h2C][20];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :109:32
        mshrStatus_st1_r = _RANDOM[6'h2C][23:21];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :156:33
      `endif // RANDOMIZE_REG_INIT
    end // initial
