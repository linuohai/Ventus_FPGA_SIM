...
module CSRFile(	// ventus/src/pipeline/CSR.scala:87:7
  ...
  input  [10:0] io_CTA2csr_bits_CTAdata_dispatch2cu_vgpr_base_dispatch,	// ventus/src/pipeline/CSR.scala:88:12
  ...
  output [10:0] io_vgpr_base,	// ventus/src/pipeline/CSR.scala:88:12
  ...
  always @(posedge clock) begin	// ventus/src/pipeline/CSR.scala:87:7
    if (reset) begin	// ventus/src/pipeline/CSR.scala:87:7
      ...
      if (io_CTA2csr_valid) begin	// ventus/src/pipeline/CSR.scala:88:12
        threadid <=
          {25'h0, io_CTA2csr_bits_CTAdata_dispatch2cu_wf_tag_dispatch[2:0], 4'h0};	// ventus/src/pipeline/CSR.scala:87:7, :160:25, :302:74, :312:13
        lds_base_dispatch <=
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/pipeline/CSR.scala:87:7
    ...
    initial begin	// ventus/src/pipeline/CSR.scala:87:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/pipeline/CSR.scala:87:7
        ...
        vgpr_base_dispatch = _RANDOM[4'hD][19:9];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :175:31
        NV = _RANDOM[4'hD][20];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :181:19
        DZ = _RANDOM[4'hD][21];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :182:19
        OF = _RANDOM[4'hD][22];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :183:19
        UF = _RANDOM[4'hD][23];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :184:19
        NX = _RANDOM[4'hD][24];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :185:19
        frm = _RANDOM[4'hD][27:25];	// ventus/src/pipeline/CSR.scala:87:7, :174:31, :187:20
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_lsu_tid = {22'h0, wf_tag_dispatch, 4'h0};	// src/main/scala/chisel3/util/Lookup.scala:34:39, ventus/src/pipeline/CSR.scala:87:7, :165:28, :315:14
