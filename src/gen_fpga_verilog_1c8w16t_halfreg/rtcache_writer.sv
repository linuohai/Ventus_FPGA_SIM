...
module rtcache_writer(	// ventus/src/cta/allocator.scala:61:7
  ...
  input  [17:0] io_rt_result_bits_size_0,	// ventus/src/cta/allocator.scala:62:15
  ...
  input  [17:0] io_alloc_size,	// ventus/src/cta/allocator.scala:62:15
  ...
  output [17:0] io_rtcache_wr_data_size_0,	// ventus/src/cta/allocator.scala:62:15
  ...
  assign io_rtcache_wr_data_size_0 =
    alloc_wr
      ? io_alloc_rawdata_size_0 - (io_alloc_sel ? 18'h0 : io_alloc_size)
  ...
  assign io_rtcache_wr_data_size_1 =
    alloc_wr
      ? io_alloc_rawdata_size_1 - (io_alloc_sel ? io_alloc_size : 18'h0)
