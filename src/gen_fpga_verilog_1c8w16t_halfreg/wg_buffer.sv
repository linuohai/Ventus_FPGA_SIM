...
module wg_buffer(	// ventus/src/cta/wg_buffer.scala:35:7
  ...
  input  [10:0] io_host_wg_new_bits_num_vgpr,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  input  [10:0] io_host_wg_new_bits_num_vgpr_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  output [10:0] io_alloc_wg_new_bits_num_vgpr,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  output [10:0] io_cuinterface_wg_new_bits_num_vgpr_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  wire [238:0] _wgram2_ext_R0_data;	// ventus/src/cta/wg_buffer.scala:56:19
  wire [76:0]  _wgram1_ext_R0_data;	// ventus/src/cta/wg_buffer.scala:55:19
  ...
  always @(posedge clock) begin	// ventus/src/cta/wg_buffer.scala:35:7
    ...
    if (wgram1_rd_act) begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      ...
      wgram1_rd_data_r_num_vgpr <= _wgram1_ext_R0_data[26:16];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
      wgram1_rd_data_r_num_lds <= _wgram1_ext_R0_data[44:27];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
      wgram1_rd_data_r_wg_id <= _wgram1_ext_R0_data[76:45];	// ventus/src/cta/wg_buffer.scala:55:19, :111:30
    ...
    if (wgram_rd2_clear_act) begin	// ventus/src/cta/wg_buffer.scala:151:80
      ...
      wgram2_rd_data_num_sgpr_per_wf <= _wgram2_ext_R0_data[177:166];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_vgpr_per_wf <= _wgram2_ext_R0_data[188:178];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_pds_per_wf <= _wgram2_ext_R0_data[205:189];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_useless <= _wgram2_ext_R0_data[206];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_wg_id <= _wgram2_ext_R0_data[238:207];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/cta/wg_buffer.scala:35:7
    ...
    initial begin	// ventus/src/cta/wg_buffer.scala:35:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/cta/wg_buffer.scala:35:7
        ...
        wgram1_rd_data_r_num_vgpr = _RANDOM[4'h1][11:1];	// ventus/src/cta/wg_buffer.scala:35:7, :111:30
        wgram1_rd_data_r_num_lds = _RANDOM[4'h1][29:12];	// ventus/src/cta/wg_buffer.scala:35:7, :111:30
        wgram1_rd_data_r_wg_id = {_RANDOM[4'h1][31:30], _RANDOM[4'h2][29:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :111:30
        wgram1_rd_data_addr = {_RANDOM[4'h2][31:30], _RANDOM[4'h3][0]};	// ventus/src/cta/wg_buffer.scala:35:7, :111:30, :112:38
        cuinterface_new_wg_valid_r = _RANDOM[4'h3][1];	// ventus/src/cta/wg_buffer.scala:35:7, :112:38, :128:43
        wgram2_rd_data_num_thread_per_wf = _RANDOM[4'h3][6:2];	// ventus/src/cta/wg_buffer.scala:35:7, :112:38, :133:33
        wgram2_rd_data_gds_base = {_RANDOM[4'h3][31:7], _RANDOM[4'h4][6:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :112:38, :133:33
        wgram2_rd_data_pds_base = {_RANDOM[4'h4][31:7], _RANDOM[4'h5][6:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_start_pc = {_RANDOM[4'h5][31:7], _RANDOM[4'h6][6:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_csr_kernel = {_RANDOM[4'h6][31:7], _RANDOM[4'h7][6:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_x = _RANDOM[4'h7][17:7];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_y = _RANDOM[4'h7][28:18];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_z = {_RANDOM[4'h7][31:29], _RANDOM[4'h8][7:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_sgpr_per_wf = _RANDOM[4'h8][19:8];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_vgpr_per_wf = _RANDOM[4'h8][30:20];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_pds_per_wf = {_RANDOM[4'h8][31], _RANDOM[4'h9][15:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_useless = _RANDOM[4'h9][16];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_wg_id = {_RANDOM[4'h9][31:17], _RANDOM[4'hA][16:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        alloc_result_wgid = {_RANDOM[4'hA][31:17], _RANDOM[4'hB][16:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33, :140:38
        wgram_rd2_clear_act_r1 = _RANDOM[4'hB][17];	// ventus/src/cta/wg_buffer.scala:35:7, :140:38, :141:41
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  wgram1_8x77 wgram1_ext (	// ventus/src/cta/wg_buffer.scala:55:19
  ...
  wgram2_8x239 wgram2_ext (	// ventus/src/cta/wg_buffer.scala:56:19
