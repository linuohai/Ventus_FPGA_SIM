...
module allocator(	// ventus/src/cta/allocator.scala:102:7
  ...
  input  [10:0] io_wgbuffer_wg_new_bits_num_vgpr,	// ventus/src/cta/allocator.scala:108:14
  ...
  output [10:0] io_rt_alloc_bits_num_vgpr,	// ventus/src/cta/allocator.scala:108:14
  ...
  always @(posedge clock) begin	// ventus/src/cta/allocator.scala:102:7
    ...
    if (reset) begin	// ventus/src/cta/allocator.scala:102:7
      ...
      rtcache_vgpr_0_size_0 <= 11'h400;	// ventus/src/cta/allocator.scala:141:29, :142:25
      rtcache_vgpr_0_size_1 <= 11'h0;	// ventus/src/cta/allocator.scala:141:29, :142:25
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/cta/allocator.scala:102:7
    ...
    initial begin	// ventus/src/cta/allocator.scala:102:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/cta/allocator.scala:102:7
        ...
        rtcache_vgpr_0_size_0 = {_RANDOM[3'h1][31:28], _RANDOM[3'h2][6:0]};	// ventus/src/cta/allocator.scala:102:7, :131:28, :141:29
        rtcache_vgpr_0_size_1 = _RANDOM[3'h2][17:7];	// ventus/src/cta/allocator.scala:102:7, :141:29
        wgslot_0 = _RANDOM[3'h2][25:18];	// ventus/src/cta/allocator.scala:102:7, :141:29, :162:23
        wfslot_0 = _RANDOM[3'h2][29:26];	// ventus/src/cta/allocator.scala:102:7, :141:29, :163:23
        wgslot_id = {_RANDOM[3'h2][31:30], _RANDOM[3'h3][0]};	// ventus/src/cta/allocator.scala:102:7, :141:29, :165:22
        wgslot_id_1H = _RANDOM[3'h3][8:1];	// ventus/src/cta/allocator.scala:102:7, :165:22, :166:25
        fsm = _RANDOM[3'h3][11:9];	// ventus/src/cta/allocator.scala:102:7, :165:22, :176:20
        fsm_r1 = _RANDOM[3'h3][14:12];	// ventus/src/cta/allocator.scala:102:7, :165:22, :177:23
        wg_num_wf = _RANDOM[3'h3][18:15];	// ventus/src/cta/allocator.scala:102:7, :165:22, :187:21
        wg_num_sgpr = _RANDOM[3'h3][30:19];	// ventus/src/cta/allocator.scala:102:7, :165:22, :187:21
        wg_num_vgpr = {_RANDOM[3'h3][31], _RANDOM[3'h4][9:0]};	// ventus/src/cta/allocator.scala:102:7, :165:22, :187:21
        wg_num_lds = _RANDOM[3'h4][27:10];	// ventus/src/cta/allocator.scala:102:7, :187:21
        wg_wg_id = {_RANDOM[3'h4][31:28], _RANDOM[3'h5][27:0]};	// ventus/src/cta/allocator.scala:102:7, :187:21
        wg_wgram_addr = _RANDOM[3'h5][30:28];	// ventus/src/cta/allocator.scala:102:7, :187:21
        cu_cnt = _RANDOM[3'h5][31];	// ventus/src/cta/allocator.scala:102:7, :187:21, :191:23
        rtcache_lds_sel = _RANDOM[3'h6][0];	// ventus/src/cta/allocator.scala:102:7, :278:35
        rtcache_sgpr_sel = _RANDOM[3'h6][1];	// ventus/src/cta/allocator.scala:102:7, :278:35, :279:35
        rtcache_vgpr_sel = _RANDOM[3'h6][2];	// ventus/src/cta/allocator.scala:102:7, :278:35, :280:35
        alloc_task_rt_reg = _RANDOM[3'h6][3];	// ventus/src/cta/allocator.scala:102:7, :278:35, :316:34
        alloc_task_cuinterface_reg = _RANDOM[3'h6][4];	// ventus/src/cta/allocator.scala:102:7, :278:35, :328:43
        alloc_task_wgram2_reg = _RANDOM[3'h6][5];	// ventus/src/cta/allocator.scala:102:7, :278:35, :344:38
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  rtcache_writer_2 writer_vgpr (	// ventus/src/cta/allocator.scala:149:27
    .clock                     (clock),
    .reset                     (reset),
