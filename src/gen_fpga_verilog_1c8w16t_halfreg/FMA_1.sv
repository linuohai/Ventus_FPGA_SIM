...
module FMA_1(	// dependencies/fpuv2/src/main/scala/FMA.scala:115:7
  ...
  FMULPipe_1 mulPipe (	// dependencies/fpuv2/src/main/scala/FMA.scala:118:23
    .clock                                (clock),
    .reset                                (reset),
    .io_in_valid
  ...
  FADDPipe_1 addPipe (	// dependencies/fpuv2/src/main/scala/FMA.scala:119:23
    .clock                                  (clock),
    .reset                                  (reset),
  ...
  Arbiter2_ArbiterIO_1 toAddArbiter (	// dependencies/fpuv2/src/main/scala/FMA.scala:133:28
  ...
  Queue1_ArbiterIO_2 toAddArbiterFIFO_0 (	// dependencies/fpuv2/src/main/scala/FMA.scala:134:44
    .clock          (clock),
    .reset          (reset),
  ...
  Queue1_ArbiterIO_2 toAddArbiterFIFO_1 (	// dependencies/fpuv2/src/main/scala/FMA.scala:134:44
    .clock          (clock),
    .reset          (reset),
    .io_enq_ready   (/* unused */),
  ...
  Queue1_FPUInput_1 inToAddFIFO (	// dependencies/fpuv2/src/main/scala/FMA.scala:145:27
    .clock          (clock),
    .reset          (reset),
  ...
  Queue1_MulToAddIO_1 mulToAddFIFO (	// dependencies/fpuv2/src/main/scala/FMA.scala:152:28
    .clock                                      (clock),
    .reset                                      (reset),
    .io_enq_valid
  ...
  Queue1_FPUOutput_2 mulFIFO (	// dependencies/fpuv2/src/main/scala/FMA.scala:167:23
    .clock              (clock),
    .reset              (reset),
    .io_enq_ready       (_mulFIFO_io_enq_ready),
    .io_enq_valid       (_mulPipe_io_out_valid & _mulPipe_io_out_ready_T_3),	// dependencies/fpuv2/src/main/scala/FMA.scala:118:23, :170:48, dependencies/fpuv2/src/main/scala/utils/FPUOps.scala:81:10
  ...
  Queue1_FPUOutput_2 addFIFO (	// dependencies/fpuv2/src/main/scala/FMA.scala:168:23
    .clock              (clock),
    .reset              (reset),
  ...
  Arbiter2_FPUOutput_1 toOutArbiter (	// dependencies/fpuv2/src/main/scala/FMA.scala:177:28
