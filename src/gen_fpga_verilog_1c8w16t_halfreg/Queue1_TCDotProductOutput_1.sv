...
module Queue1_TCDotProductOutput_1(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      ram <= {io_enq_bits_fflags, io_enq_bits_result};	// src/main/scala/chisel3/util/Decoupled.scala:256:91
