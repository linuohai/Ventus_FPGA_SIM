...
module ram_8x16(	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  input  [2:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [15:0] R0_data,
  ...
  reg [15:0] Memory[0:7];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:256:91
        for (logic [3:0] i = 4'h0; i < 4'h8; i += 4'h1) begin
          ...
          Memory[i[2:0]] = _RANDOM_MEM[15:0];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
