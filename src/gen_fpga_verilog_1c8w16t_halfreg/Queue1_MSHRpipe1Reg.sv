...
module Queue1_MSHRpipe1Reg(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  input  [3:0] io_enq_bits_entryMatchProbe,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input  [1:0] io_enq_bits_subEntryIdx,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input        io_deq_ready,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output       io_deq_valid,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [3:0] io_deq_bits_entryMatchProbe,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [1:0] io_deq_bits_subEntryIdx	// src/main/scala/chisel3/util/Decoupled.scala:255:14
);
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      ram <= {io_enq_bits_subEntryIdx, io_enq_bits_entryMatchProbe};	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  assign io_deq_bits_entryMatchProbe = ram[3:0];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_subEntryIdx = ram[5:4];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
endmodule
