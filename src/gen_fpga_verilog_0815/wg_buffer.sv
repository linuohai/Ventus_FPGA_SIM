...
module wg_buffer(	// ventus/src/cta/wg_buffer.scala:35:7
  ...
  input  [15:0] io_host_wg_new_bits_num_pds_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  input  [3:0]  io_host_wg_new_bits_num_thread_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  output [3:0]  io_cuinterface_wg_new_bits_num_thread_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  output [15:0] io_cuinterface_wg_new_bits_num_pds_per_wf,	// ventus/src/cta/wg_buffer.scala:36:14
  ...
  wire [235:0] _wgram2_ext_R0_data;	// ventus/src/cta/wg_buffer.scala:56:19
  wire [74:0]  _wgram1_ext_R0_data;	// ventus/src/cta/wg_buffer.scala:55:19
  wire [3:0]   wgram2_wr_data_num_thread_per_wf = io_host_wg_new_bits_num_thread_per_wf;	// ventus/src/cta/wg_buffer.scala:61:28
  ...
  wire [15:0]  wgram2_wr_data_num_pds_per_wf = io_host_wg_new_bits_num_pds_per_wf;	// ventus/src/cta/wg_buffer.scala:61:28
  ...
  reg  [3:0]   wgram2_rd_data_num_thread_per_wf;	// ventus/src/cta/wg_buffer.scala:133:33
  ...
  reg  [15:0]  wgram2_rd_data_num_pds_per_wf;	// ventus/src/cta/wg_buffer.scala:133:33
  ...
  always @(posedge clock) begin	// ventus/src/cta/wg_buffer.scala:35:7
    ...
    if (wgram_rd2_clear_act) begin	// ventus/src/cta/wg_buffer.scala:151:80
      wgram2_rd_data_num_thread_per_wf <= _wgram2_ext_R0_data[3:0];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_gds_base <= _wgram2_ext_R0_data[35:4];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_pds_base <= _wgram2_ext_R0_data[67:36];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_start_pc <= _wgram2_ext_R0_data[99:68];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_csr_kernel <= _wgram2_ext_R0_data[131:100];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_wg_x <= _wgram2_ext_R0_data[142:132];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_wg_y <= _wgram2_ext_R0_data[153:143];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_wg_z <= _wgram2_ext_R0_data[164:154];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_sgpr_per_wf <= _wgram2_ext_R0_data[175:165];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_vgpr_per_wf <= _wgram2_ext_R0_data[186:176];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_num_pds_per_wf <= _wgram2_ext_R0_data[202:187];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_useless <= _wgram2_ext_R0_data[203];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
      wgram2_rd_data_wg_id <= _wgram2_ext_R0_data[235:204];	// ventus/src/cta/wg_buffer.scala:56:19, :133:33
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/cta/wg_buffer.scala:35:7
    ...
    initial begin	// ventus/src/cta/wg_buffer.scala:35:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/cta/wg_buffer.scala:35:7
        ...
        wgram2_rd_data_num_thread_per_wf = _RANDOM[4'h3][3:0];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_gds_base = {_RANDOM[4'h3][31:4], _RANDOM[4'h4][3:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_pds_base = {_RANDOM[4'h4][31:4], _RANDOM[4'h5][3:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_start_pc = {_RANDOM[4'h5][31:4], _RANDOM[4'h6][3:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_csr_kernel = {_RANDOM[4'h6][31:4], _RANDOM[4'h7][3:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_x = _RANDOM[4'h7][14:4];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_y = _RANDOM[4'h7][25:15];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_wg_z = {_RANDOM[4'h7][31:26], _RANDOM[4'h8][4:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_sgpr_per_wf = _RANDOM[4'h8][15:5];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_vgpr_per_wf = _RANDOM[4'h8][26:16];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_num_pds_per_wf = {_RANDOM[4'h8][31:27], _RANDOM[4'h9][10:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_useless = _RANDOM[4'h9][11];	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        wgram2_rd_data_wg_id = {_RANDOM[4'h9][31:12], _RANDOM[4'hA][11:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33
        alloc_result_wgid = {_RANDOM[4'hA][31:12], _RANDOM[4'hB][11:0]};	// ventus/src/cta/wg_buffer.scala:35:7, :133:33, :140:38
        wgram_rd2_clear_act_r1 = _RANDOM[4'hB][12];	// ventus/src/cta/wg_buffer.scala:35:7, :140:38, :141:41
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  wgram2_8x236 wgram2_ext (	// ventus/src/cta/wg_buffer.scala:56:19
