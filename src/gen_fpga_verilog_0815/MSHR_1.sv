...
module MSHR_1(	// ventus/src/L1Cache/L1MSHR.scala:79:7
  ...
  input  [81:0] io_missReq_bits_targetInfo,	// ventus/src/L1Cache/L1MSHR.scala:80:14
  ...
  output [81:0] io_missRspOut_bits_targetInfo,	// ventus/src/L1Cache/L1MSHR.scala:80:14
  ...
  reg  [81:0]      targetInfo_Accesss_0_0;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [81:0]      targetInfo_Accesss_0_1;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [81:0]      targetInfo_Accesss_1_0;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [81:0]      targetInfo_Accesss_1_1;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [81:0]      targetInfo_Accesss_2_0;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [81:0]      targetInfo_Accesss_2_1;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [81:0]      targetInfo_Accesss_3_0;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  reg  [81:0]      targetInfo_Accesss_3_1;	// ventus/src/L1Cache/L1MSHR.scala:102:35
  ...
  always @(posedge clock) begin	// ventus/src/L1Cache/L1MSHR.scala:79:7
    if (reset) begin	// ventus/src/L1Cache/L1MSHR.scala:79:7
      ...
      targetInfo_Accesss_0_0 <= 82'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_0_1 <= 82'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_1_0 <= 82'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_1_1 <= 82'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_2_0 <= 82'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_2_1 <= 82'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_3_0 <= 82'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
      targetInfo_Accesss_3_1 <= 82'h0;	// ventus/src/L1Cache/L1MSHR.scala:102:{35,72}
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/L1Cache/L1MSHR.scala:79:7
    ...
    initial begin	// ventus/src/L1Cache/L1MSHR.scala:79:7
      automatic logic [31:0] _RANDOM[0:24];	// ventus/src/L1Cache/L1MSHR.scala:79:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/L1Cache/L1MSHR.scala:79:7
        ...
        blockAddr_Access_0 = _RANDOM[5'h0][24:0];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :100:33
        blockAddr_Access_1 = {_RANDOM[5'h0][31:25], _RANDOM[5'h1][17:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :100:33
        blockAddr_Access_2 = {_RANDOM[5'h1][31:18], _RANDOM[5'h2][10:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :100:33
        blockAddr_Access_3 = {_RANDOM[5'h2][31:11], _RANDOM[5'h3][3:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :100:33
        targetInfo_Accesss_0_0 =
          {_RANDOM[5'h3][31:12], _RANDOM[5'h4], _RANDOM[5'h5][29:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :100:33, :102:35
        targetInfo_Accesss_0_1 =
          {_RANDOM[5'h5][31:30], _RANDOM[5'h6], _RANDOM[5'h7], _RANDOM[5'h8][15:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_1_0 =
          {_RANDOM[5'h8][31:16], _RANDOM[5'h9], _RANDOM[5'hA], _RANDOM[5'hB][1:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_1_1 =
          {_RANDOM[5'hB][31:2], _RANDOM[5'hC], _RANDOM[5'hD][19:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_2_0 =
          {_RANDOM[5'hD][31:20], _RANDOM[5'hE], _RANDOM[5'hF], _RANDOM[5'h10][5:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_2_1 =
          {_RANDOM[5'h10][31:6], _RANDOM[5'h11], _RANDOM[5'h12][23:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_3_0 =
          {_RANDOM[5'h12][31:24], _RANDOM[5'h13], _RANDOM[5'h14], _RANDOM[5'h15][9:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        targetInfo_Accesss_3_1 =
          {_RANDOM[5'h15][31:10], _RANDOM[5'h16], _RANDOM[5'h17][27:0]};	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35
        subentry_valid_0_0 = _RANDOM[5'h17][28];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        subentry_valid_0_1 = _RANDOM[5'h17][29];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        subentry_valid_1_0 = _RANDOM[5'h17][30];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        subentry_valid_1_1 = _RANDOM[5'h17][31];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :102:35, :105:31
        subentry_valid_2_0 = _RANDOM[5'h18][0];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :105:31
        subentry_valid_2_1 = _RANDOM[5'h18][1];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :105:31
        subentry_valid_3_0 = _RANDOM[5'h18][2];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :105:31
        subentry_valid_3_1 = _RANDOM[5'h18][3];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :105:31
        releasing_stall_0 = _RANDOM[5'h18][5];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :105:31, :109:32
        releasing_stall_1 = _RANDOM[5'h18][6];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :105:31, :109:32
        releasing_stall_2 = _RANDOM[5'h18][7];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :105:31, :109:32
        releasing_stall_3 = _RANDOM[5'h18][8];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :105:31, :109:32
        mshrStatus_st1_r = _RANDOM[5'h18][11:9];	// ventus/src/L1Cache/L1MSHR.scala:79:7, :105:31, :156:33
      `endif // RANDOMIZE_REG_INIT
    end // initial
