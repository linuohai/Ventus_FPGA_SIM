...
module DataCrossbar(	// ventus/src/L1Cache/ShareMem/BankConflictArbiter.scala:60:7
  ...
  input  [7:0]  io_Select1H_0,	// ventus/src/L1Cache/ShareMem/BankConflictArbiter.scala:61:12
  ...
  assign io_DataOut_0 =
    ...
    | (io_Select1H_0[6] ? io_DataIn_6 : 32'h0) | (io_Select1H_0[7] ? io_DataIn_7 : 32'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, :32:36, ventus/src/L1Cache/ShareMem/BankConflictArbiter.scala:60:7
  assign io_DataOut_1 =
    ...
    | (io_Select1H_1[6] ? io_DataIn_6 : 32'h0) | (io_Select1H_1[7] ? io_DataIn_7 : 32'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, :32:36, ventus/src/L1Cache/ShareMem/BankConflictArbiter.scala:60:7
  assign io_DataOut_2 =
    ...
    | (io_Select1H_2[6] ? io_DataIn_6 : 32'h0) | (io_Select1H_2[7] ? io_DataIn_7 : 32'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, :32:36, ventus/src/L1Cache/ShareMem/BankConflictArbiter.scala:60:7
  assign io_DataOut_3 =
    ...
    | (io_Select1H_3[6] ? io_DataIn_6 : 32'h0) | (io_Select1H_3[7] ? io_DataIn_7 : 32'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, :32:36, ventus/src/L1Cache/ShareMem/BankConflictArbiter.scala:60:7
  assign io_DataOut_4 =
    ...
    | (io_Select1H_4[6] ? io_DataIn_6 : 32'h0) | (io_Select1H_4[7] ? io_DataIn_7 : 32'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, :32:36, ventus/src/L1Cache/ShareMem/BankConflictArbiter.scala:60:7
  assign io_DataOut_5 =
    ...
    | (io_Select1H_5[6] ? io_DataIn_6 : 32'h0) | (io_Select1H_5[7] ? io_DataIn_7 : 32'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, :32:36, ventus/src/L1Cache/ShareMem/BankConflictArbiter.scala:60:7
  assign io_DataOut_6 =
    ...
    | (io_Select1H_6[6] ? io_DataIn_6 : 32'h0) | (io_Select1H_6[7] ? io_DataIn_7 : 32'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, :32:36, ventus/src/L1Cache/ShareMem/BankConflictArbiter.scala:60:7
  assign io_DataOut_7 =
    ...
    | (io_Select1H_7[6] ? io_DataIn_6 : 32'h0) | (io_Select1H_7[7] ? io_DataIn_7 : 32'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, :32:36, ventus/src/L1Cache/ShareMem/BankConflictArbiter.scala:60:7
endmodule
