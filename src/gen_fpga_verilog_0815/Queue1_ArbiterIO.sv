...
module Queue1_ArbiterIO(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  output [4:0]  io_deq_bits_ctrl_regIndex,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [1:0]  io_deq_bits_ctrl_warpID,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [7:0]  io_deq_bits_ctrl_vecMask,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  ...
  output [2:0]  io_deq_bits_op	// src/main/scala/chisel3/util/Decoupled.scala:255:14
);

  reg  [91:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    ...
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      ram <=
        {io_enq_bits_op,
         ...
         io_enq_bits_ctrl_regIndex};	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Decoupled.scala:243:7
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][28:0]};	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  ...
  assign io_deq_bits_ctrl_regIndex = ram[4:0];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_warpID = ram[6:5];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_vecMask = ram[14:7];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_wvd = ram[15];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_wxd = ram[16];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_spike_info_sm_id = ram[24:17];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_spike_info_pc = ram[56:25];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_ctrl_spike_info_inst = ram[88:57];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_op = ram[91:89];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
endmodule
