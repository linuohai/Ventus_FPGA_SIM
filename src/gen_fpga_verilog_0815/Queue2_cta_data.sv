...
module Queue2_cta_data(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  input  [15:0] io_enq_bits_num_pds_per_wf,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input  [3:0]  io_enq_bits_num_thread_per_wf,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  ...
  output [15:0] io_deq_bits_num_pds_per_wf,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [3:0]  io_deq_bits_num_thread_per_wf,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  ...
  wire [248:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  ram_2x249 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  assign io_deq_bits_num_wf = _ram_ext_R0_data[5:3];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_lds_dealloc_en = _ram_ext_R0_data[6];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_sgpr_dealloc_en = _ram_ext_R0_data[7];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_vgpr_dealloc_en = _ram_ext_R0_data[8];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_sgpr_base = _ram_ext_R0_data[18:9];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_vgpr_base = _ram_ext_R0_data[28:19];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_lds_base = _ram_ext_R0_data[45:29];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_num_sgpr_per_wf = _ram_ext_R0_data[56:46];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_num_vgpr_per_wf = _ram_ext_R0_data[67:57];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_num_pds_per_wf = _ram_ext_R0_data[83:68];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_num_thread_per_wf = _ram_ext_R0_data[87:84];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_pds_base = _ram_ext_R0_data[119:88];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_start_pc = _ram_ext_R0_data[151:120];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_csr_kernel = _ram_ext_R0_data[183:152];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_num_wg_x = _ram_ext_R0_data[194:184];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_num_wg_y = _ram_ext_R0_data[205:195];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_num_wg_z = _ram_ext_R0_data[216:206];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wg_id = _ram_ext_R0_data[248:217];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
endmodule
