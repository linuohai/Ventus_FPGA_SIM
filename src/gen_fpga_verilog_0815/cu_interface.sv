...
module cu_interface(	// ventus/src/cta/cu_interface.scala:14:7
  ...
  input  [3:0]  io_wgbuffer_wg_new_bits_num_thread_per_wf,	// ventus/src/cta/cu_interface.scala:16:14
  ...
  input  [15:0] io_wgbuffer_wg_new_bits_num_pds_per_wf,	// ventus/src/cta/cu_interface.scala:16:14
  ...
  output [3:0]  io_cu_wf_new_0_bits_num_thread_per_wf,	// ventus/src/cta/cu_interface.scala:16:14
  ...
  wire [15:0] _fifo_io_deq_bits_num_pds_per_wf;	// ventus/src/cta/cu_interface.scala:46:20
  ...
  `ifndef SYNTHESIS	// ventus/src/cta/cu_interface.scala:50:13
    always @(posedge clock) begin	// ventus/src/cta/cu_interface.scala:50:13
      ...
      _GEN_4 = splitter_cnt < 3'h2;	// ventus/src/cta/cu_interface.scala:71:29, :95:23, :132:96
  ...
  always @(posedge clock) begin	// ventus/src/cta/cu_interface.scala:14:7
    ...
    if (reset) begin	// ventus/src/cta/cu_interface.scala:14:7
      ...
      init_wf_gather_cnt_idx <= 4'h0;	// ventus/src/cta/cu_interface.scala:166:39
      ...
      if (~io_init_ok_0)	// ventus/src/cta/cu_interface.scala:167:56
        init_wf_gather_cnt_idx <= init_wf_gather_cnt_idx + 4'h1;	// ventus/src/cta/cu_interface.scala:80:91, :166:39, :167:133
    ...
    if (splitter_load_new)	// ventus/src/cta/cu_interface.scala:76:50
      ...
      splitter_pds_addr <= splitter_pds_addr + {16'h0, _fifo_io_deq_bits_num_pds_per_wf};	// ventus/src/cta/cu_interface.scala:46:20, :75:30, :93:69
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/cta/cu_interface.scala:14:7
    ...
    initial begin	// ventus/src/cta/cu_interface.scala:14:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/cta/cu_interface.scala:14:7
        ...
        fsm = {_RANDOM[2'h1][31], _RANDOM[2'h2][0]};	// ventus/src/cta/cu_interface.scala:14:7, :75:30, :147:20
        wf_wgslot_reg = _RANDOM[2'h2][3:1];	// ventus/src/cta/cu_interface.scala:14:7, :147:20, :162:32
        init_wf_gather_cnt_idx = _RANDOM[2'h2][7:4];	// ventus/src/cta/cu_interface.scala:14:7, :147:20, :166:39
        wf_gather_ram_read_data_tmp = _RANDOM[2'h2][8];	// ventus/src/cta/cu_interface.scala:14:7, :147:20, :173:22
        wf_gather_ram_read_data_r_num_wf = _RANDOM[2'h2][11:9];	// ventus/src/cta/cu_interface.scala:14:7, :147:20, :175:29
        wf_gather_ram_read_data_r_wg_id = {_RANDOM[2'h2][31:12], _RANDOM[2'h3][11:0]};	// ventus/src/cta/cu_interface.scala:14:7, :147:20, :175:29
        wf_gather_ram_read_data_r_lds_dealloc_en = _RANDOM[2'h3][12];	// ventus/src/cta/cu_interface.scala:14:7, :175:29
        wf_gather_ram_read_data_r_sgpr_dealloc_en = _RANDOM[2'h3][13];	// ventus/src/cta/cu_interface.scala:14:7, :175:29
        wf_gather_ram_read_data_r_vgpr_dealloc_en = _RANDOM[2'h3][14];	// ventus/src/cta/cu_interface.scala:14:7, :175:29
        rt_dealloc_ok = _RANDOM[2'h3][15];	// ventus/src/cta/cu_interface.scala:14:7, :175:29, :200:42
        host_wg_done_ok = _RANDOM[2'h3][16];	// ventus/src/cta/cu_interface.scala:14:7, :175:29, :217:44
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue2_cta_data fifo (	// ventus/src/cta/cu_interface.scala:46:20
    ...
    .io_deq_ready                  (splitter_cnt == 3'h1 & io_cu_wf_new_0_ready),	// ventus/src/cta/cu_interface.scala:14:7, :71:29, :77:{38,47}
  ...
  wf_gather_ram wf_gather_ram (	// ventus/src/cta/cu_interface.scala:127:34
    .R0_addr (_arb_inst_io_out_bits_wf_tag[4:2]),	// ventus/src/cta/cu_interface.scala:154:24, :161:60
  ...
  wf_gather_cnt wf_gather_cnt (	// ventus/src/cta/cu_interface.scala:165:34
    ...
    .W0_clk  (clock),
    .W0_data (~_GEN | wf_gather_finish ? 3'h0 : _wf_gather_cnt_write_data_T_1)	// ventus/src/cta/cu_interface.scala:14:7, :179:{51,57}, :180:{37,61}, :181:37
  );
  ...
  assign io_cu_wf_new_0_bits_wf_tag =
    {_fifo_io_deq_bits_wg_slot_id, _fifo_io_deq_bits_num_wf[1:0] - splitter_cnt[1:0]};	// ventus/src/cta/cu_interface.scala:14:7, :46:20, :71:29, :80:91, :110:46, :111:13
