...
module branch_join(	// ventus/src/pipeline/branch_join.scala:65:7
  ...
  input  [7:0]  io_branch_ctl_bits_mask_init,	// ventus/src/pipeline/branch_join.scala:66:14
                io_branch_ctl_bits_spike_info_sm_id,	// ventus/src/pipeline/branch_join.scala:66:14
  ...
  input  [7:0]  io_if_mask_bits_if_mask,	// ventus/src/pipeline/branch_join.scala:66:14
  ...
  output [7:0]  io_out_mask,	// ventus/src/pipeline/branch_join.scala:66:14
  ...
  wire [7:0]       _branch_join_stack_3_io_newMask;	// ventus/src/pipeline/branch_join.scala:112:51
  ...
  wire [7:0]       _branch_join_stack_2_io_newMask;	// ventus/src/pipeline/branch_join.scala:112:51
  ...
  wire [7:0]       _branch_join_stack_1_io_newMask;	// ventus/src/pipeline/branch_join.scala:112:51
  ...
  wire [7:0]       _branch_join_stack_io_newMask;	// ventus/src/pipeline/branch_join.scala:112:51
  ...
  wire [7:0]       _branch_ctl_buf_q_io_deq_bits_mask_init;	// src/main/scala/chisel3/util/Decoupled.scala:362:21
  ...
  reg  [7:0]       thread_masks_0;	// ventus/src/pipeline/branch_join.scala:90:29
  reg  [7:0]       thread_masks_1;	// ventus/src/pipeline/branch_join.scala:90:29
  reg  [7:0]       thread_masks_2;	// ventus/src/pipeline/branch_join.scala:90:29
  reg  [7:0]       thread_masks_3;	// ventus/src/pipeline/branch_join.scala:90:29
       ...
       {1'h0, {1'h0, if_mask[4]} + {1'h0, if_mask[5]}}
         + {1'h0,
            {1'h0, if_mask[6]}
              + {1'h0,
                 if_mask[7]}}} < {1'h0,
                                  {1'h0, {1'h0, else_mask[0]} + {1'h0, else_mask[1]}}
                                    + {1'h0, {1'h0, else_mask[2]} + {1'h0, else_mask[3]}}}
    + {1'h0,
       {1'h0, {1'h0, else_mask[4]} + {1'h0, else_mask[5]}}
         + {1'h0, {1'h0, else_mask[6]} + {1'h0, else_mask[7]}}} & ~_divOccur_T | ifOnly;	// ventus/src/pipeline/branch_join.scala:65:7, :141:39, :142:51, :143:20, :144:22, :145:{21,32,45}, :146:25, :148:{15,24}
  assign ifOnly = else_mask == 8'h0;	// ventus/src/pipeline/branch_join.scala:142:51, :146:25
  wire             elseOnly = if_mask == 8'h0;	// ventus/src/pipeline/branch_join.scala:141:39, :146:25, :147:30
  assign _divOccur_T = ifOnly | elseOnly;	// ventus/src/pipeline/branch_join.scala:146:25, :147:30, :148:24
  wire [7:0]       pushentry_newMask = takeif ? else_mask : if_mask;	// ventus/src/pipeline/branch_join.scala:141:39, :142:51, :145:45, :150:15, :151:23, :154:23
  ...
  wire             _pop_1_T_3 = _branch_ctl_buf_q_io_deq_bits_wid == 2'h1;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:159:73, :235:31
  wire             _pop_2_T_3 = _branch_ctl_buf_q_io_deq_bits_wid == 2'h2;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:159:73
  wire [3:0]       _GEN_0 =
  ...
  wire [7:0]       popMask = _GEN_2[_branch_ctl_buf_q_io_deq_bits_wid];	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:172:11
  wire             _GEN_3 =
  ...
  `ifndef SYNTHESIS	// ventus/src/pipeline/branch_join.scala:213:15
    always @(posedge clock) begin	// ventus/src/pipeline/branch_join.scala:213:15
      ...
      if ((`PRINTF_COND_) & _GEN_5 & ~_branch_ctl_buf_q_io_deq_bits_opcode & ~reset) begin	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:206:68, :208:39, :213:15
        automatic logic [7:0] mask = takeif ? if_mask : else_mask;	// ventus/src/pipeline/branch_join.scala:141:39, :142:51, :145:45, :210:23
        $fwrite(32'h80000002,
                "sm %d warp %d 0x%x 0x%x vbranch     current mask and npc:   %x%x%x%x%x%x%x%x 0x%x, take_if=%d\n",
                ...
                _branch_ctl_buf_q_io_deq_bits_spike_info_inst, mask[7], mask[6], mask[5],
      ...
      if ((`PRINTF_COND_) & _branch_ctl_buf_q_io_deq_bits_opcode
        ...
        $fwrite(32'h80000002,
                "sm %d warp %d 0x%x 0x%x join    mask and npc:    %x%x%x%x%x%x%x%x 0x%x pop stack ? %d\n",
                _branch_ctl_buf_q_io_deq_bits_spike_info_sm_id,
                _branch_ctl_buf_q_io_deq_bits_wid,
                _branch_ctl_buf_q_io_deq_bits_spike_info_pc,
                _branch_ctl_buf_q_io_deq_bits_spike_info_inst, popMask[7], popMask[6],
                popMask[5], popMask[4], popMask[3], popMask[2], popMask[1], popMask[0],
                popPC, popjump);	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:170:11, :171:10, :172:11, :213:15, :221:27, :223:13
    end // always @(posedge)
  `endif // not def SYNTHESIS
  wire [3:0][7:0]  _GEN_6 =
  ...
  always @(posedge clock) begin	// ventus/src/pipeline/branch_join.scala:65:7
    if (reset) begin	// ventus/src/pipeline/branch_join.scala:65:7
      thread_masks_0 <= 8'hFF;	// ventus/src/pipeline/branch_join.scala:90:{29,57}
      thread_masks_1 <= 8'hFF;	// ventus/src/pipeline/branch_join.scala:90:{29,57}
      thread_masks_2 <= 8'hFF;	// ventus/src/pipeline/branch_join.scala:90:{29,57}
      thread_masks_3 <= 8'hFF;	// ventus/src/pipeline/branch_join.scala:90:{29,57}
    end
      ...
      _GEN_7 = _branch_ctl_buf_q_io_deq_bits_wid == 2'h1;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:235:31
      _GEN_8 = _branch_ctl_buf_q_io_deq_bits_wid == 2'h2;	// src/main/scala/chisel3/util/Decoupled.scala:362:21, ventus/src/pipeline/branch_join.scala:159:73, :235:31
      if (_q_io_deq_ready_T_1) begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35
        automatic logic [7:0] _GEN_9;	// ventus/src/pipeline/branch_join.scala:90:29, :235:31, :237:31
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/pipeline/branch_join.scala:65:7
    ...
    initial begin	// ventus/src/pipeline/branch_join.scala:65:7
      automatic logic [31:0] _RANDOM[0:0];	// ventus/src/pipeline/branch_join.scala:65:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/pipeline/branch_join.scala:65:7
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// ventus/src/pipeline/branch_join.scala:65:7
        thread_masks_0 = _RANDOM[/*Zero width*/ 1'b0][7:0];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
        thread_masks_1 = _RANDOM[/*Zero width*/ 1'b0][15:8];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
        thread_masks_2 = _RANDOM[/*Zero width*/ 1'b0][23:16];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
        thread_masks_3 = _RANDOM[/*Zero width*/ 1'b0][31:24];	// ventus/src/pipeline/branch_join.scala:65:7, :90:29
      `endif // RANDOMIZE_REG_INIT
    end // initial
