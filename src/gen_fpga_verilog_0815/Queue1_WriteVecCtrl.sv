...
module Queue1_WriteVecCtrl(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  reg  [346:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Decoupled.scala:243:7
        ...
        ram =
          {_RANDOM[4'h0][31:1],
           ...
           _RANDOM[4'h8],
           _RANDOM[4'h9],
           _RANDOM[4'hA][27:0]};	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  ...
  assign io_deq_bits_wvd_mask_0 = ram[256];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wvd_mask_1 = ram[257];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wvd_mask_2 = ram[258];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wvd_mask_3 = ram[259];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wvd_mask_4 = ram[260];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wvd_mask_5 = ram[261];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wvd_mask_6 = ram[262];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wvd_mask_7 = ram[263];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wvd = ram[264];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_reg_idxw = ram[272:265];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_warp_id = ram[274:273];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_spike_info_sm_id = ram[282:275];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_spike_info_pc = ram[314:283];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_spike_info_inst = ram[346:315];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
endmodule
