...
module ArrayMultiplier(	// ventus/src/pipeline/Multiplier.scala:149:7
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/pipeline/Multiplier.scala:149:7
    ...
    initial begin	// ventus/src/pipeline/Multiplier.scala:149:7
      automatic logic [31:0] _RANDOM[0:16];	// ventus/src/pipeline/Multiplier.scala:149:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/pipeline/Multiplier.scala:149:7
        ...
        r_2_wid = _RANDOM[5'h8][14:13];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_2_reg_idxw = _RANDOM[5'hA][23:16];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_2_wvd = _RANDOM[5'hA][24];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_2_wxd = _RANDOM[5'hA][29];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_2_spike_info_sm_id = _RANDOM[5'hC][12:5];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_2_spike_info_pc = {_RANDOM[5'hC][31:13], _RANDOM[5'hD][12:0]};	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_2_spike_info_inst = {_RANDOM[5'hD][31:13], _RANDOM[5'hE][12:0]};	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_3_0 = _RANDOM[5'hE][16];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_3_1 = _RANDOM[5'hE][17];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_3_2 = _RANDOM[5'hE][18];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_3_3 = _RANDOM[5'hE][19];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_3_4 = _RANDOM[5'hE][20];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_3_5 = _RANDOM[5'hE][21];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_3_6 = _RANDOM[5'hE][22];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_3_7 = _RANDOM[5'hE][23];	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        r_4 = {_RANDOM[5'hE][31:24], _RANDOM[5'hF][23:0]};	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
        io_out_bits_result_r = {_RANDOM[5'hF][31:24], _RANDOM[5'h10][23:0]};	// ventus/src/pipeline/Multiplier.scala:149:7, ventus/src/pipeline/mul_utils.scala:54:56
      `endif // RANDOMIZE_REG_INIT
    end // initial
