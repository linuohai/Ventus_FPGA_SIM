...
module MSHR(	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7
  ...
  always @(posedge clock) begin	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7
    if (reset) begin	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7
      ...
      automatic logic [1:0] subentry_next2cancel =
        _subentryStatus_io_valid_list_T_7
          ...
          : _subentryStatus_io_valid_list_T_6
              ? 2'h1
              : {1'h1, ~_subentryStatus_io_valid_list_T_3};	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:77:14, :85:72, :107:46, :109:55, :139:51
      ...
      automatic logic       _GEN_8 = _entryStatus_io_next == 2'h0;	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:85:72, :113:27, :183:26
      ...
      automatic logic       _GEN_10 = _GEN_9 == 2'h0;	// src/main/scala/chisel3/util/OneHot.scala:32:10, ventus/src/L1Cache/ICache/ICacheMSHR.scala:85:72, :186:32
      automatic logic       _GEN_11 = _subentryStatus_io_next == 2'h0;	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:85:72, :106:30, :187:26
      automatic logic       _GEN_12 = _missRspInHoldingIdx_T == 2'h0;	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:85:72, :121:29, :190:24
      automatic logic       _GEN_13;	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:189:39
      automatic logic       _GEN_14 = subentry_next2cancel == 2'h0;	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:85:72, :109:55, :191:27
      ...
      has_send2mem_0 <=
        ...
        & has_send2mem_0;	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:85:72, :116:29, :190:24, :208:29, :212:41, :215:{24,31,57}, :216:25, :217:{73,105,134}, :218:25
      has_send2mem_1 <=
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7
    ...
    initial begin	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7
      automatic logic [31:0] _RANDOM[0:4];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7
        ...
        subentry_valid_0_0 = _RANDOM[3'h4][4];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_0_1 = _RANDOM[3'h4][5];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_0_2 = _RANDOM[3'h4][6];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_0_3 = _RANDOM[3'h4][7];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_1_0 = _RANDOM[3'h4][8];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_1_1 = _RANDOM[3'h4][9];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_1_2 = _RANDOM[3'h4][10];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_1_3 = _RANDOM[3'h4][11];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_2_0 = _RANDOM[3'h4][12];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_2_1 = _RANDOM[3'h4][13];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_2_2 = _RANDOM[3'h4][14];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_2_3 = _RANDOM[3'h4][15];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_3_0 = _RANDOM[3'h4][16];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_3_1 = _RANDOM[3'h4][17];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_3_2 = _RANDOM[3'h4][18];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        subentry_valid_3_3 = _RANDOM[3'h4][19];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31
        missRsqBusy = _RANDOM[3'h4][20];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31, :119:28
        missRspInHoldingIdx_REG = _RANDOM[3'h4][22:21];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31, :121:49
        has_send2mem_0 = _RANDOM[3'h4][23];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31, :208:29
        has_send2mem_1 = _RANDOM[3'h4][24];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31, :208:29
        has_send2mem_2 = _RANDOM[3'h4][25];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31, :208:29
        has_send2mem_3 = _RANDOM[3'h4][26];	// ventus/src/L1Cache/ICache/ICacheMSHR.scala:73:7, :104:31, :208:29
      `endif // RANDOMIZE_REG_INIT
    end // initial
