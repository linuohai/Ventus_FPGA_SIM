...
module FloatRegFileBank(	// ventus/src/pipeline/regfile.scala:39:7
  ...
  wire [255:0] _regs_R0_data;	// ventus/src/pipeline/regfile.scala:41:25
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/pipeline/regfile.scala:39:7
    ...
    initial begin	// ventus/src/pipeline/regfile.scala:39:7
      automatic logic [31:0] _RANDOM[0:8];	// ventus/src/pipeline/regfile.scala:39:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/pipeline/regfile.scala:39:7
        ...
        bypassSignal_REG = _RANDOM[4'h0][0];	// ventus/src/pipeline/regfile.scala:39:7, :45:26
        REG_0 = {_RANDOM[4'h0][31:1], _RANDOM[4'h1][0]};	// ventus/src/pipeline/regfile.scala:39:7, :45:26, :46:36
        REG_1 = {_RANDOM[4'h1][31:1], _RANDOM[4'h2][0]};	// ventus/src/pipeline/regfile.scala:39:7, :46:36
        REG_2 = {_RANDOM[4'h2][31:1], _RANDOM[4'h3][0]};	// ventus/src/pipeline/regfile.scala:39:7, :46:36
        REG_3 = {_RANDOM[4'h3][31:1], _RANDOM[4'h4][0]};	// ventus/src/pipeline/regfile.scala:39:7, :46:36
        REG_4 = {_RANDOM[4'h4][31:1], _RANDOM[4'h5][0]};	// ventus/src/pipeline/regfile.scala:39:7, :46:36
        REG_5 = {_RANDOM[4'h5][31:1], _RANDOM[4'h6][0]};	// ventus/src/pipeline/regfile.scala:39:7, :46:36
        REG_6 = {_RANDOM[4'h6][31:1], _RANDOM[4'h7][0]};	// ventus/src/pipeline/regfile.scala:39:7, :46:36
        REG_7 = {_RANDOM[4'h7][31:1], _RANDOM[4'h8][0]};	// ventus/src/pipeline/regfile.scala:39:7, :46:36
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  regs regs (	// ventus/src/pipeline/regfile.scala:41:25
    ...
    .W0_en   (io_rdwen),
    .W0_clk  (clock),
    .W0_data ({io_rd_7, io_rd_6, io_rd_5, io_rd_4, io_rd_3, io_rd_2, io_rd_1, io_rd_0}),	// ventus/src/pipeline/regfile.scala:41:25
    .W0_mask
      ({io_rdwmask_7,
        io_rdwmask_6,
        io_rdwmask_5,
