...
module Queue1_WriteScalarCtrl(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  input         clock,	// src/main/scala/chisel3/util/Decoupled.scala:243:7
                reset,	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  output        io_enq_ready,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input         io_enq_valid,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input  [31:0] io_enq_bits_wb_wxd_rd,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input         io_enq_bits_wxd,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  ...
  output [31:0] io_deq_bits_wb_wxd_rd,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output        io_deq_bits_wxd,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  ...
  reg  [114:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    ...
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      ram <=
        {io_enq_bits_spike_info_inst,
         ...
         io_enq_bits_wxd,
         io_enq_bits_wb_wxd_rd};	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Decoupled.scala:243:7
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][19:0]};	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  ...
  assign io_deq_bits_wb_wxd_rd = ram[31:0];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_wxd = ram[32];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_reg_idxw = ram[40:33];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_warp_id = ram[42:41];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_spike_info_sm_id = ram[50:43];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_spike_info_pc = ram[82:51];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_spike_info_inst = ram[114:83];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
endmodule
