...
module SRAMTemplate_3(	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
  ...
  output [9:0] io_r_resp_data_0,	// ventus/src/SRAMTemplate/SRAMTemplate.scala:90:14
  ...
  input  [9:0] io_w_req_bits_data_0,	// ventus/src/SRAMTemplate/SRAMTemplate.scala:90:14
  ...
  wire [19:0] _array_R0_data;	// ventus/src/SRAMTemplate/SRAMTemplate.scala:96:26
  reg  [9:0]  bypass_wdata_REG_0;	// ventus/src/SRAMTemplate/SRAMTemplate.scala:128:54
  reg  [9:0]  bypass_wdata_REG_1;	// ventus/src/SRAMTemplate/SRAMTemplate.scala:128:54
  ...
  wire [9:0]  mem_rdata_0 = bypass_mask[0] ? bypass_wdata_REG_0 : _array_R0_data[9:0];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:96:26, :125:67, :128:54, :133:30, :134:30
  wire [9:0]  mem_rdata_1 = bypass_mask[1] ? bypass_wdata_REG_1 : _array_R0_data[19:10];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:96:26, :125:67, :128:54, :133:30, :134:30
  reg         rdata_REG;	// ventus/src/SRAMTemplate/SRAMTemplate.scala:139:59
  reg  [9:0]  rdata_r_0;	// ventus/src/SRAMTemplate/Hold.scala:18:65
  reg  [9:0]  rdata_r_1;	// ventus/src/SRAMTemplate/Hold.scala:18:65
  always @(posedge clock) begin	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
    ...
    if (reset) begin	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
      rdata_r_0 <= 10'h0;	// ventus/src/SRAMTemplate/Hold.scala:18:65, ventus/src/SRAMTemplate/SRAMTemplate.scala:112:51
      rdata_r_1 <= 10'h0;	// ventus/src/SRAMTemplate/Hold.scala:18:65, ventus/src/SRAMTemplate/SRAMTemplate.scala:112:51
    end
  ...
  `ifdef ENABLE_INITIAL_REG_	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
    ...
    initial begin	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7
        ...
        bypass_wdata_REG_0 = _RANDOM[1'h0][9:0];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :128:54
        bypass_wdata_REG_1 = _RANDOM[1'h0][19:10];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :128:54
        bypass_mask_need_check = _RANDOM[1'h0][20];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :121:29, :128:54
        bypass_mask_waddr_reg = _RANDOM[1'h0][28:21];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :122:28, :128:54
        bypass_mask_raddr_reg = {_RANDOM[1'h0][31:29], _RANDOM[1'h1][4:0]};	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :123:28, :128:54
        bypass_mask_bypass_REG = _RANDOM[1'h1][6:5];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :123:28, :125:76
        rdata_REG = _RANDOM[1'h1][7];	// ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :123:28, :139:59
        rdata_r_0 = _RANDOM[1'h1][17:8];	// ventus/src/SRAMTemplate/Hold.scala:18:65, ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :123:28
        rdata_r_1 = _RANDOM[1'h1][27:18];	// ventus/src/SRAMTemplate/Hold.scala:18:65, ventus/src/SRAMTemplate/SRAMTemplate.scala:88:7, :123:28
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  array_2 array (	// ventus/src/SRAMTemplate/SRAMTemplate.scala:96:26
